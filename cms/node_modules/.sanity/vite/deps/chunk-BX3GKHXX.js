...
function stateThemeColor_v0_v2(v0, state2) {
  var _a, _b;
  return {
    ...state2,
    avatar: {
    ...
    muted: {
      ...
      bg: state2.bg2 || state2.bg
    },
    skeleton: {
      from: ((_a = state2.skeleton) == null ? void 0 : _a.from) || state2.border,
      to: ((_b = state2.skeleton) == null ? void 0 : _b.to) || state2.border
    }
  };
}
...
function inputStateThemeColor_v0_v2(state2) {
  return {
    bg: state2.bg,
    border: state2.border,
    fg: state2.fg,
    muted: {
      bg: state2.bg2
    },
    placeholder: state2.placeholder
  };
}
...
function resolveButtonModeColorTokens(inputTokens, mode, tone) {
  const tokens = {};
  for (const state2 of THEME_COLOR_STATES)
    tokens[state2] = resolveButtonStateColorTokens(inputTokens, tone, mode, state2);
  return tokens;
}
function resolveButtonStateColorTokens(inputTokens, tone, mode, state2) {
  var _a, _b, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n;
  const spec = merge((_c = (_b = (_a = inputTokens == null ? void 0 : inputTokens.button) == null ? void 0 : _a[mode]) == null ? void 0 : _b["*"]) == null ? void 0 : _c["*"], (_f = (_e2 = (_d = inputTokens == null ? void 0 : inputTokens.button) == null ? void 0 : _d[mode]) == null ? void 0 : _e2[tone]) == null ? void 0 : _f["*"], (_i = (_h = (_g = inputTokens == null ? void 0 : inputTokens.button) == null ? void 0 : _g[mode]) == null ? void 0 : _h["*"]) == null ? void 0 : _i[state2], (_l = (_k = (_j = inputTokens == null ? void 0 : inputTokens.button) == null ? void 0 : _j[mode]) == null ? void 0 : _k[tone]) == null ? void 0 : _l[state2]), hue = spec._hue || ((_n = (_m = inputTokens == null ? void 0 : inputTokens.base) == null ? void 0 : _m[tone]) == null ? void 0 : _n._hue);
  return {
    ...spec,
    _hue: hue,
    avatar: COLOR_HUES.reduce((acc, hue2) => {
...
function resolveInputModeColorTokens(inputTokens, mode) {
  const states = {};
  for (const state2 of THEME_COLOR_INPUT_STATES)
    states[state2] = resolveInputStateColorTokens(inputTokens, mode, state2);
  return states;
}
function resolveInputStateColorTokens(inputTokens, mode, state2) {
  var _a, _b, _c, _d, _e2, _f, _g, _h, _i, _j;
  const spec = merge((_b = (_a = inputTokens == null ? void 0 : inputTokens.input) == null ? void 0 : _a["*"]) == null ? void 0 : _b["*"], (_d = (_c = inputTokens == null ? void 0 : inputTokens.input) == null ? void 0 : _c[mode]) == null ? void 0 : _d["*"], (_f = (_e2 = inputTokens == null ? void 0 : inputTokens.input) == null ? void 0 : _e2["*"]) == null ? void 0 : _f[state2], (_h = (_g = inputTokens == null ? void 0 : inputTokens.input) == null ? void 0 : _g[mode]) == null ? void 0 : _h[state2]), hue = spec._hue || ((_j = (_i = inputTokens == null ? void 0 : inputTokens.input) == null ? void 0 : _i[mode]) == null ? void 0 : _j._hue);
  return {
    ...spec,
    _hue: hue
  };
...
function resolveSelectableToneColorTokens(inputTokens, tone) {
  ...
  for (const state2 of THEME_COLOR_STATES)
    states[state2] = resolveSelectableStateColorTokens(inputTokens, tone, state2);
  return states;
}
function resolveSelectableStateColorTokens(inputTokens, tone, state2) {
  var _a, _b, _c, _d, _e2, _f, _g, _h, _i, _j;
  const spec = merge((_b = (_a = inputTokens == null ? void 0 : inputTokens.selectable) == null ? void 0 : _a["*"]) == null ? void 0 : _b["*"], (_d = (_c = inputTokens == null ? void 0 : inputTokens.selectable) == null ? void 0 : _c[tone]) == null ? void 0 : _d["*"], (_f = (_e2 = inputTokens == null ? void 0 : inputTokens.selectable) == null ? void 0 : _e2["*"]) == null ? void 0 : _f[state2], (_h = (_g = inputTokens == null ? void 0 : inputTokens.selectable) == null ? void 0 : _g[tone]) == null ? void 0 : _h[state2]), hue = spec._hue || ((_j = (_i = inputTokens == null ? void 0 : inputTokens.base) == null ? void 0 : _i[tone]) == null ? void 0 : _j._hue);
  return {
    ...spec,
    _hue: hue,
    avatar: COLOR_HUES.reduce((acc, hue2) => {
...
function buildButtonStatesColorTheme(options, config) {
  ...
  for (const state2 of THEME_COLOR_STATES)
    states[state2] = buildButtonStateColorTheme({
      cardTone,
      mode,
      tone,
      scheme,
...
function buildButtonStateColorTheme(options, config) {
  ...
  const {
    ...
    scheme,
    state: state2
  } = options, cardTokens = (_b = (_a = config == null ? void 0 : config.color) == null ? void 0 : _a.base) == null ? void 0 : _b[cardTone], tokens = (_f = (_e2 = (_d = (_c = config == null ? void 0 : config.color) == null ? void 0 : _c.button) == null ? void 0 : _d[mode]) == null ? void 0 : _e2[tone]) == null ? void 0 : _f[state2], hue = (tokens == null ? void 0 : tokens._hue) || (cardTokens == null ? void 0 : cardTokens._hue) || "gray", blendMode = (tokens == null ? void 0 : tokens._blend) || ["screen", "multiply"], context = {
    hue,
    scheme
  };
  return {
...
function buildInputStateColorTheme(options, config) {
  ...
  const {
    ...
    scheme,
    state: state2
  } = options, cardTokens = (_b = (_a = config == null ? void 0 : config.color) == null ? void 0 : _a.base) == null ? void 0 : _b[cardTone], tokens = (_e2 = (_d = (_c = config == null ? void 0 : config.color) == null ? void 0 : _c.input) == null ? void 0 : _d[mode]) == null ? void 0 : _e2[state2], hue = (tokens == null ? void 0 : tokens._hue) || (cardTokens == null ? void 0 : cardTokens._hue) || "gray", blendMode = (tokens == null ? void 0 : tokens._blend) || ["screen", "multiply"], context = {
    hue,
    scheme
  };
  return {
...
function buildSelectableStatesColorTheme(options, config) {
  ...
  for (const state2 of THEME_COLOR_STATES)
    states[state2] = buildSelectableStateColorTheme({
      cardTone,
      tone,
      scheme,
      state: state2
...
function buildSelectableStateColorTheme(options, config) {
  ...
  const {
    ...
    state: state2,
    tone
  } = options, cardTokens = (_b = (_a = config == null ? void 0 : config.color) == null ? void 0 : _a.base) == null ? void 0 : _b[cardTone], tokens = (_e2 = (_d = (_c = config == null ? void 0 : config.color) == null ? void 0 : _c.selectable) == null ? void 0 : _d[tone]) == null ? void 0 : _e2[state2], hue = (tokens == null ? void 0 : tokens._hue) || (cardTokens == null ? void 0 : cardTokens._hue) || "gray", blendMode = (tokens == null ? void 0 : tokens._blend) || ["screen", "multiply"], context = {
    hue,
    scheme
  };
  return {
...
function rgbToHsl({
  ...
  let h = 0, s2 = 0, l2 = 0;
  return delta == 0 ? h = 0 : cmax == r2 ? h = (g2 - b2) / delta % 6 : cmax == g2 ? h = (b2 - r2) / delta + 2 : h = (r2 - g2) / delta + 4, h = Math.round(h * 60), h < 0 && (h += 360), l2 = (cmax + cmin) / 2, s2 = delta == 0 ? 0 : delta / (1 - Math.abs(2 * l2 - 1)), s2 = +(s2 * 100).toFixed(1), l2 = +(l2 * 100).toFixed(1), {
    h,
    s: s2,
    l: l2
  };
...
function PopChild({ children, isPresent, anchorX }) {
  ...
  return (0, import_jsx_runtime.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size5, children: React2.cloneElement(children, { ref }) });
}
...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX }) => {
  ...
  const memoizedOnExitComplete = (0, import_react8.useCallback)((childId) => {
...
function useVisualElement(Component4, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  var _a, _b;
  const { visualElement: parent } = (0, import_react24.useContext)(MotionContext);
  const lazyContext = (0, import_react24.useContext)(LazyContext);
  const presenceContext = (0, import_react24.useContext)(PresenceContext);
  const reducedMotionConfig = (0, import_react24.useContext)(MotionConfigContext).reducedMotion;
  const visualElementRef = (0, import_react24.useRef)(null);
  ...
  const initialLayoutGroupConfig = (0, import_react24.useContext)(SwitchLayoutGroupContext);
  ...
  const wantsHandoff = (0, import_react24.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) === null || _a === void 0 ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) === null || _b === void 0 ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
    if (!visualElement)
      return;
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState: useVisualState2, Component: Component4 }) {
  ...
  const ForwardRefMotionComponent = (0, import_react25.forwardRef)(MotionComponent);
  ForwardRefMotionComponent[motionComponentSymbol] = Component4;
  return ForwardRefMotionComponent;
}
function useLayoutId({ layoutId }) {
  const layoutGroupId = (0, import_react25.useContext)(LayoutGroupContext).id;
  return layoutGroupId && layoutId !== void 0 ? layoutGroupId + "-" + layoutId : layoutId;
}
function useStrictMode(configAndProps, preloadedFeatures) {
  const isStrict = (0, import_react25.useContext)(LazyContext).strict;
...
function calcOrigin(origin2, offset4, size5) {
  return typeof origin2 === "string" ? origin2 : px.transform(offset4 + size5 * origin2);
}
...
function getValueState(visualElement) {
  ...
  visualElement === null || visualElement === void 0 ? void 0 : visualElement.values.forEach((value, key2) => {
    state2[0][key2] = value.get();
    state2[1][key2] = value.getVelocity();
  });
  return state2;
}
...
function scrapeMotionValuesFromProps(props, prevProps, visualElement) {
  ...
  for (const key2 in style) {
    if (isMotionValue(style[key2]) || prevProps.style && isMotionValue(prevProps.style[key2]) || isForcedMotionValue(key2, props) || ((_a = visualElement === null || visualElement === void 0 ? void 0 : visualElement.getValue(key2)) === null || _a === void 0 ? void 0 : _a.liveStyle) !== void 0) {
...
var BaseGroupPlaybackControls = class {
  ...
  get finished() {
    return Promise.all(this.animations.map((animation2) => "finished" in animation2 ? animation2.finished : animation2));
  }
  /**
  ...
  attachTimeline(timeline, fallback) {
    const subscriptions = this.animations.map((animation2) => {
      if (supportsScrollTimeline() && animation2.attachTimeline) {
        return animation2.attachTimeline(timeline);
      } else if (typeof fallback === "function") {
        return fallback(animation2);
      }
    });
    return () => {
...
function attachTimeline(animation2, timeline) {
...
var clampRgbUnit = (v2) => clamp3(0, 255, v2);
var rgbUnit = {
  ...number,
    ...
    elementsToMeasure.forEach((element) => {
      ...
      if (restore) {
        restore.forEach(([key2, value]) => {
          var _a;
          (_a = element.getValue(key2)) === null || _a === void 0 ? void 0 : _a.set(value);
        });
      }
    });
...
var MainThreadAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes$1) {
    ...
    if (generatorFactory !== keyframes && typeof keyframes$1[0] !== "number") {
      mapPercentToKeyframes = pipe(percentToProgress, mix2(keyframes$1[0], keyframes$1[1]));
      keyframes$1 = [0, 100];
    }
...
function startWaapiAnimation(element, valueName, keyframes2, { delay: delay2 = 0, duration = 300, repeat = 0, repeatType = "loop", ease: ease2 = "easeInOut", times } = {}) {
  ...
  const animation2 = element.animate(keyframeOptions, {
    delay: delay2,
    duration,
...
var AcceleratedAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes2, finalKeyframe) {
    ...
    const animation2 = startWaapiAnimation(motionValue2.owner.current, name, keyframes2, { ...this.options, duration, times, ease: ease2 });
    animation2.startTime = startTime !== null && startTime !== void 0 ? startTime : this.calcStartTime();
    if (this.pendingTimeline) {
      attachTimeline(animation2, this.pendingTimeline);
  ...
  attachTimeline(timeline) {
    if (!this._resolved) {
      ...
      if (!resolved)
        return noop;
      const { animation: animation2 } = resolved;
      attachTimeline(animation2, timeline);
    }
    return noop;
  }
  play() {
  ...
  stop() {
    ...
    if (!resolved)
      return;
    const { animation: animation2, keyframes: keyframes2, duration, type, ease: ease2, times } = resolved;
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react30.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
var createDomVisualElement = (Component4, options) => {
  return isSVGComponent(Component4) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component4 !== import_react31.Fragment
  });
};
...
function createScopedAnimate(scope) {
  function scopedAnimate(subjectOrSequence, optionsOrKeyframes, options) {
    ...
    const animation2 = new GroupPlaybackControls(animations2);
    if (scope) {
...
function useEffectEvent(fn) {
  ...
  return (0, import_react51.useInsertionEffect)(() => {
    ref.current = fn;
  }, [fn]), (0, import_react51.useCallback)((...args) => {
...
// node_modules/@sanity/ui/dist/_chunks-es/_visual-editing.mjs
var createColorTheme2 = createColorTheme;
var hexToRgb2 = hexToRgb;
var hslToRgb2 = hslToRgb;
var multiply2 = multiply;
var parseColor2 = parseColor;
var rgbToHex2 = rgbToHex;
var rgbToHsl2 = rgbToHsl;
var rgba3 = rgba;
var screen2 = screen;
...
function LayerProvider(props) {
  ...
  $2[3] !== parentRegisterChild || $2[4] !== setChildLayers ? (t3 = (childLevel) => {
    ...
    return childLevel !== void 0 ? setChildLayers((state2) => {
      const prevLen = state2[childLevel] ?? 0, nextState = {
        ...state2,
...
})`&:not([hidden]){display:flex;}flex-direction:column;width:max-content;min-width:min-content;& > *{opacity:var(${POPOVER_MOTION_CONTENT_OPACITY_PROPERTY},1);will-change:opacity;}`;
var PopoverCard = (0, import_react52.memo)((0, import_react52.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(60);
  ...
  let t9;
  $2[36] !== animate2 ? (t9 = animate2 ? POPOVER_MOTION_PROPS : {}, $2[36] = animate2, $2[37] = t9) : t9 = $2[37];
  let t10;
  $2[38] !== children || $2[39] !== padding ? (t10 = (0, import_jsx_runtime12.jsx)(Flex, { direction: "column", flex: 1, padding, children }), $2[38] = children, $2[39] = padding, $2[40] = t10) : t10 = $2[40];
  let t11;
  $2[41] !== overflow || $2[42] !== t10 ? (t11 = (0, import_jsx_runtime12.jsx)(Flex, { "data-ui": "Popover__wrapper", direction: "column", flex: 1, overflow, children: t10 }), $2[41] = overflow, $2[42] = t10, $2[43] = t11) : t11 = $2[43];
  let t12;
  $2[44] !== arrow22 || $2[45] !== arrowRef || $2[46] !== arrowStyle ? (t12 = arrow22 && (0, import_jsx_runtime12.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_POPOVER_ARROW_WIDTH, height: DEFAULT_POPOVER_ARROW_HEIGHT, radius: DEFAULT_POPOVER_ARROW_RADIUS }), $2[44] = arrow22, $2[45] = arrowRef, $2[46] = arrowStyle, $2[47] = t12) : t12 = $2[47];
  let t13;
  return $2[48] !== placement || $2[49] !== radius || $2[50] !== ref || $2[51] !== rootStyle2 || $2[52] !== scheme || $2[53] !== shadow || $2[54] !== t11 || $2[55] !== t12 || $2[56] !== t8 || $2[57] !== t9 || $2[58] !== tone ? (t13 = (0, import_jsx_runtime12.jsxs)(MotionCard$1, { "data-ui": "Popover", ...t8, "data-placement": placement, radius, ref, scheme, shadow, sizing: "border", style: rootStyle2, tone, ...t9, children: [
    t11,
    t12
  ] }), $2[48] = placement, $2[49] = radius, $2[50] = ref, $2[51] = rootStyle2, $2[52] = scheme, $2[53] = shadow, $2[54] = t11, $2[55] = t12, $2[56] = t8, $2[57] = t9, $2[58] = tone, $2[59] = t13) : t13 = $2[59], t13;
}));
...
function useDelayedState(initialState) {
  const $2 = (0, import_react_compiler_runtime.c)(3), [state2, setState] = (0, import_react52.useState)(initialState), delayedAction = (0, import_react52.useRef)(void 0);
  let t0;
  ...
  let t1;
  return $2[1] !== state2 ? (t1 = [state2, onStateChange], $2[1] = state2, $2[2] = t1) : t1 = $2[2], t1;
}
...
})`& > *{opacity:var(${POPOVER_MOTION_CONTENT_OPACITY_PROPERTY},1);will-change:opacity;}`;
var TooltipCard = (0, import_react52.memo)((0, import_react52.forwardRef)(function(props, ref) {
  ...
  let t8;
  $2[24] !== animate2 ? (t8 = animate2 ? POPOVER_MOTION_PROPS : {}, $2[24] = animate2, $2[25] = t8) : t8 = $2[25];
  let t9;
  $2[26] !== arrow22 || $2[27] !== arrowRef || $2[28] !== arrowStyle ? (t9 = arrow22 && (0, import_jsx_runtime12.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_TOOLTIP_ARROW_WIDTH, height: DEFAULT_TOOLTIP_ARROW_HEIGHT, radius: DEFAULT_TOOLTIP_ARROW_RADIUS }), $2[26] = arrow22, $2[27] = arrowRef, $2[28] = arrowStyle, $2[29] = t9) : t9 = $2[29];
  let t10;
  return $2[30] !== children || $2[31] !== padding || $2[32] !== placement || $2[33] !== radius || $2[34] !== ref || $2[35] !== rootStyle2 || $2[36] !== scheme || $2[37] !== shadow || $2[38] !== t7 || $2[39] !== t8 || $2[40] !== t9 ? (t10 = (0, import_jsx_runtime12.jsxs)(MotionCard, { "data-ui": "Tooltip__card", ...t7, "data-placement": placement, padding, radius, ref, scheme, shadow, style: rootStyle2, ...t8, children: [
    children,
    t9
  ] }), $2[30] = children, $2[31] = padding, $2[32] = placement, $2[33] = radius, $2[34] = ref, $2[35] = rootStyle2, $2[36] = scheme, $2[37] = shadow, $2[38] = t7, $2[39] = t8, $2[40] = t9, $2[41] = t10) : t10 = $2[41], t10;
}));
...
function TooltipDelayGroupProvider(props) {
  ...
  let t2;
  $2[0] !== closeDelay || $2[1] !== isGroupActive || $2[2] !== openTooltipId || $2[3] !== setIsGroupActive || $2[4] !== setOpenTooltipId || $2[5] !== t1 ? (t2 = {
    isGroupActive,
    setIsGroupActive,
    openTooltipId,
    setOpenTooltipId,
    openDelay: t1,
    closeDelay
  }, $2[0] = closeDelay, $2[1] = isGroupActive, $2[2] = openTooltipId, $2[3] = setIsGroupActive, $2[4] = setOpenTooltipId, $2[5] = t1, $2[6] = t2) : t2 = $2[6], t0 = t2;
  const value = t0;
  let t3;
  return $2[7] !== children || $2[8] !== value ? (t3 = (0, import_jsx_runtime12.jsx)(TooltipDelayGroupContext.Provider, { value, children }), $2[7] = children, $2[8] = value, $2[9] = t3) : t3 = $2[9], t3;
}
...
var Tooltip = (0, import_react52.forwardRef)(function(props, forwardedRef) {
  ...
  }, [isInsideGroup, delayGroupContext, openDelay, tooltipId, closeDelay, setIsOpen]), handleBlur = (0, import_react52.useCallback)((e) => {
    var _a2, _b2;
  ...
  }, [content, handleIsOpenChange, showTooltip]), (0, import_react52.useEffect)(() => {
  ...
  }, zOffset, children: (0, import_jsx_runtime12.jsx)(TooltipCard, { ...restProps, animate: animate2, arrow: arrowProp, arrowRef: setArrow, arrowX, arrowY, originX, originY, padding, placement, radius, ref: setFloating, scheme, shadow, children: content }) }), children = showTooltip && (portalProp ? (0, import_jsx_runtime12.jsx)(Portal, { __unstable_name: typeof portalProp == "string" ? portalProp : void 0, children: tooltip }) : tooltip);
  return (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    animate2 ? (0, import_jsx_runtime12.jsx)(AnimatePresence, { children }) : children,
    child
  ] });
...
function useCloseOnMouseLeave(t0) {
  const $2 = (0, import_react_compiler_runtime.c)(8), {
    handleIsOpenChange,
    referenceElement,
    showTooltip
  } = t0;
  ...
  let t2;
  $2[3] !== onMouseMove || $2[4] !== showTooltip ? (t2 = () => {
    if (!showTooltip)
      return;
  ...
  }, $2[3] = onMouseMove, $2[4] = showTooltip, $2[5] = t2) : t2 = $2[5];
  let t3;
  $2[6] !== showTooltip ? (t3 = [showTooltip], $2[6] = showTooltip, $2[7] = t3) : t3 = $2[7], (0, import_react52.useEffect)(t2, t3);
}
...
var MenuItem = (0, import_react52.forwardRef)(function(props, forwardedRef) {
  const $2 = (0, import_react_compiler_runtime.c)(74);
  ...
  let t23;
  $2[44] !== IconComponent || $2[45] !== IconRightComponent || $2[46] !== fontSize2 || $2[47] !== hotkeys || $2[48] !== hotkeysFontSize || $2[49] !== paddingProps || $2[50] !== space || $2[51] !== text ? (t23 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime12.jsxs)(Flex, { as: "span", gap: space, align: "center", ...paddingProps, children: [
    IconComponent && (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react52.isValidElement)(IconComponent) && IconComponent,
      (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime12.jsx)(IconComponent, {})
    ] }),
  ...
  ] }), $2[44] = IconComponent, $2[45] = IconRightComponent, $2[46] = fontSize2, $2[47] = hotkeys, $2[48] = hotkeysFontSize, $2[49] = paddingProps, $2[50] = space, $2[51] = text, $2[52] = t23) : t23 = $2[52];
  let t24;
  $2[53] !== children || $2[54] !== paddingProps ? (t24 = children && (0, import_jsx_runtime12.jsx)(Box, { as: "span", ...paddingProps, children }), $2[53] = children, $2[54] = paddingProps, $2[55] = t24) : t24 = $2[55];
  let t25;
  return $2[56] !== as || $2[57] !== disabled || $2[58] !== handleClick || $2[59] !== onItemMouseEnter || $2[60] !== onItemMouseLeave || $2[61] !== restProps || $2[62] !== scheme || $2[63] !== t15 || $2[64] !== t16 || $2[65] !== t17 || $2[66] !== t18 || $2[67] !== t19 || $2[68] !== t20 || $2[69] !== t21 || $2[70] !== t22 || $2[71] !== t23 || $2[72] !== t24 ? (t25 = (0, import_jsx_runtime12.jsxs)(Selectable, { "data-ui": "MenuItem", role: "menuitem", ...restProps, "aria-pressed": t15, "data-pressed": t16, "data-selected": t17, "data-disabled": t18, forwardedAs: as, $radius: t19, $padding: t20, $tone: t21, $scheme: scheme, disabled, onClick: handleClick, onMouseEnter: onItemMouseEnter, onMouseLeave: onItemMouseLeave, ref: setRef, tabIndex: -1, type: t22, children: [
    t23,
    t24
  ] }), $2[56] = as, $2[57] = disabled, $2[58] = handleClick, $2[59] = onItemMouseEnter, $2[60] = onItemMouseLeave, $2[61] = restProps, $2[62] = scheme, $2[63] = t15, $2[64] = t16, $2[65] = t17, $2[66] = t18, $2[67] = t19, $2[68] = t20, $2[69] = t21, $2[70] = t22, $2[71] = t23, $2[72] = t24, $2[73] = t25) : t25 = $2[73], t25;
});
...
function useForwardedRef(ref) {
  const $2 = (0, import_react_compiler_runtime2.c)(1), innerRef = (0, import_react53.useRef)(null);
  let t0;
  return $2[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => innerRef.current, $2[0] = t0) : t0 = $2[0], (0, import_react53.useImperativeHandle)(ref, t0), innerRef;
}
...
function autocompleteReducer(state2, msg2) {
  return msg2.type === "input/change" ? {
    ...
    ...state2,
    query: state2.query || msg2.query
  } : msg2.type === "root/setActiveValue" ? {
    ...state2,
    activeValue: msg2.value,
    listFocused: msg2.listFocused || state2.listFocused
...
var InnerAutocomplete = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  const {
    ...
    value: valueProp,
    ...restProps
  } = props, [state2, dispatch] = (0, import_react53.useReducer)(autocompleteReducer, {
    ...
    query,
    value
  } = state2, defaultRenderOption = (0, import_react53.useCallback)(({
    value: value_0
  ...
  }, resultsPopoverElementRef) : filteredOptionsLen === 0 ? null : (0, import_jsx_runtime13.jsx)(Popover, { arrow: false, constrainSize: true, content, fallbackPlacements: AUTOCOMPLETE_POPOVER_FALLBACK_PLACEMENTS, matchReferenceWidth: true, onMouseEnter: handlePopoverMouseEnter, onMouseLeave: handlePopoverMouseLeave, open: expanded, overflow: "auto", placement: AUTOCOMPLETE_POPOVER_PLACEMENT, portal: true, radius, ref: resultsPopoverElementRef, referenceElement: inputElementRef.current, ...popover }), [content, expanded, filteredOptionsLen, handlePopoverMouseEnter, handlePopoverMouseLeave, popover, radius, renderPopover]);
...
var MenuButton = (0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  $2[12] === Symbol.for("react.memo_cache_sentinel") ? (t9 = () => {
    setOpen(_temp$12), setShouldFocus(null);
  }, $2[12] = t9) : t9 = $2[12];
...
function rootStyles(props) {
  const {
    color: color3
  } = getTheme_v2(props.theme), loadingBarColor = color3.button.default[props.tone].enabled.bg;
...
function Toast(props) {
  ...
  $2[0] !== props ? ({
    ...
    status,
    ...restProps
  } = props, $2[0] = props, $2[1] = closable, $2[2] = description, $2[3] = duration, $2[4] = onClose, $2[5] = restProps, $2[6] = status, $2[7] = t0, $2[8] = title) : (closable = $2[1], description = $2[2], duration = $2[3], onClose = $2[4], restProps = $2[5], status = $2[6], t0 = $2[7], title = $2[8]);
  ...
  let t1;
  $2[9] !== title ? (t1 = title && (0, import_jsx_runtime13.jsx)(Text, { size: 1, weight: "medium", children: title }), $2[9] = title, $2[10] = t1) : t1 = $2[10];
  let t2;
  $2[11] !== description ? (t2 = description && (0, import_jsx_runtime13.jsx)(Text, { muted: true, size: 1, children: description }), $2[11] = description, $2[12] = t2) : t2 = $2[12];
  let t3;
  $2[13] !== t1 || $2[14] !== t2 ? (t3 = (0, import_jsx_runtime13.jsx)(TextBox, { flex: 1, padding: 3, children: (0, import_jsx_runtime13.jsxs)(Stack, { space: 3, children: [
    t1,
    t2
  ] }) }), $2[13] = t1, $2[14] = t2, $2[15] = t3) : t3 = $2[15];
  let t4;
  $2[16] !== buttonTone || $2[17] !== closable || $2[18] !== onClose ? (t4 = closable && (0, import_jsx_runtime13.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime13.jsx)(Button, { as: "button", icon: CloseIcon, mode: "bleed", padding: 2, tone: buttonTone, onClick: onClose, style: {
    verticalAlign: "top"
  } }) }), $2[16] = buttonTone, $2[17] = closable, $2[18] = onClose, $2[19] = t4) : t4 = $2[19];
  let t5;
  $2[20] !== t3 || $2[21] !== t4 ? (t5 = (0, import_jsx_runtime13.jsxs)(Flex, { align: "flex-start", children: [
    t3,
    t4
  ] }), $2[20] = t3, $2[21] = t4, $2[22] = t5) : t5 = $2[22];
  let t6;
  return $2[23] !== cardTone || $2[24] !== duration || $2[25] !== radius || $2[26] !== restProps || $2[27] !== role || $2[28] !== t5 ? (t6 = (0, import_jsx_runtime13.jsx)(StyledToast, { "data-ui": "Toast", role, ...restProps, marginTop: 3, radius, shadow: 2, tone: cardTone, $duration: duration, children: t5 }), $2[23] = cardTone, $2[24] = duration, $2[25] = radius, $2[26] = restProps, $2[27] = role, $2[28] = t5, $2[29] = t6) : t6 = $2[29], t6;
}
Toast.displayName = "Toast";
function useMounted() {
  return (0, import_react53.useSyncExternalStore)(subscribe, _temp4, _temp22);
}
function _temp22() {
  return false;
}
...
function ToastProvider(props) {
  ...
  const [state2, _setState] = (0, import_react53.useState)(t1);
  let t2;
  $2[1] === Symbol.for("react.memo_cache_sentinel") ? (t2 = {}, $2[1] = t2) : t2 = $2[1];
  const toastsRef = (0, import_react53.useRef)(t2), mounted = useMounted(), prefersReducedMotion2 = usePrefersReducedMotion();
  let t3, t4, t5, t6;
  $2[2] === Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    opacity: 0,
    [POPOVER_MOTION_CONTENT_OPACITY_PROPERTY]: -1,
    y: 32,
    scale: 0.25,
    ...
    [POPOVER_MOTION_CONTENT_OPACITY_PROPERTY]: -1,
    scale: 0.5
  }, $2[2] = t4, $2[3] = t5, $2[4] = t6) : (t4 = $2[2], t5 = $2[3], t6 = $2[4]);
  const t7 = prefersReducedMotion2 ? 0 : 0.2;
  let t8;
  $2[5] !== t7 ? (t8 = {
    initial: t4,
    animate: t5,
  ...
  }, $2[5] = t7, $2[6] = t8) : t8 = $2[6], t3 = t8;
  const variants = t3;
  let t9, t10;
  $2[7] === Symbol.for("react.memo_cache_sentinel") ? (t10 = {
    version: 0,
    push: (params) => {
      const setState = (state_0) => (0, import_react53.startTransition)(() => _setState(state_0)), id3 = params.id || generateToastId(), duration = params.duration || 5e3, dismiss = () => {
        var _a;
      ...
      return setState((prevState_0) => prevState_0.filter((t_0) => t_0.id !== id3).concat([{
        dismiss,
        id: id3,
        params: {
          ...params,
      ...
      }])), toastsRef.current[id3] && (clearTimeout(toastsRef.current[id3].timeoutId), delete toastsRef.current[id3]), toastsRef.current[id3] = {
        timeoutId: setTimeout(dismiss, duration)
      }, id3;
    }
  }, $2[7] = t10) : t10 = $2[7], t9 = t10;
  const value = t9;
  let t11, t12;
  $2[8] === Symbol.for("react.memo_cache_sentinel") ? (t11 = () => () => {
    for (const {
      timeoutId: timeoutId_0
    } of Object.values(toastsRef.current))
      clearTimeout(timeoutId_0);
    toastsRef.current = {};
  }, t12 = [], $2[8] = t11, $2[9] = t12) : (t11 = $2[8], t12 = $2[9]), (0, import_react53.useEffect)(t11, t12);
  let t13;
  $2[10] !== mounted || $2[11] !== padding || $2[12] !== paddingX || $2[13] !== paddingY || $2[14] !== prefersReducedMotion2 || $2[15] !== state2 || $2[16] !== variants || $2[17] !== zOffset ? (t13 = mounted && (0, import_jsx_runtime13.jsx)(StyledToastProvider, { "data-ui": "ToastProvider", zOffset, children: (0, import_jsx_runtime13.jsx)(ToastContainer, { children: (0, import_jsx_runtime13.jsx)(Box, { padding, paddingX, paddingY, children: (0, import_jsx_runtime13.jsx)(AnimatePresence, { initial: false, children: state2.map((t142) => {
    const {
      dismiss: dismiss_0,
      id: id_0,
      params: params_0
    } = t142;
    return (0, import_jsx_runtime13.jsx)(motion.div, { layout: "position", initial: "initial", animate: "animate", exit: "exit", variants, transition: prefersReducedMotion2 ? {
      duration: 0
    } : {
      type: "spring",
      damping: 30,
      stiffness: 400
    }, children: (0, import_jsx_runtime13.jsx)(Toast, { closable: params_0.closable, description: params_0.description, onClose: dismiss_0, status: params_0.status, title: params_0.title, duration: params_0.duration }) }, id_0);
  }) }) }) }) }), $2[10] = mounted, $2[11] = padding, $2[12] = paddingX, $2[13] = paddingY, $2[14] = prefersReducedMotion2, $2[15] = state2, $2[16] = variants, $2[17] = zOffset, $2[18] = t13) : t13 = $2[18];
  let t14;
  return $2[19] !== children || $2[20] !== t13 ? (t14 = (0, import_jsx_runtime13.jsxs)(ToastContext.Provider, { value, children: [
    children,
    t13
  ] }), $2[19] = children, $2[20] = t13, $2[21] = t14) : t14 = $2[21], t14;
}
...
function _findPrevItemElement(state2, itemElements, focusedElement) {
  var _a;
  ...
  for (let i2 = len - 1; i2 >= 0; i2 -= 1) {
    ...
    for (let j2 = 0; j2 < segments.length; j2 += 1) {
      p2.push(segments[j2]);
      const k2 = p2.join("/");
      if (!((_a = state2[k2]) == null ? void 0 : _a.expanded)) {
        expanded = false;
        break;
      }
    }
...
function _findNextItemElement(state2, itemElements, focusedElement) {
  var _a;
...
var Tree = (0, import_react53.memo)((0, import_react53.forwardRef)(function(props, forwardedRef) {
  ...
  const [state2, setState] = (0, import_react53.useState)(t4), stateRef = (0, import_react53.useRef)(state2);
  let t5;
  ...
  }, t9 = [state2], $2[12] = state2, $2[13] = t8, $2[14] = t9) : (t8 = $2[13], t9 = $2[14]), (0, import_react53.useEffect)(t8, t9);
  let t10;
  ...
  let t14;
  $2[17] !== space || $2[18] !== state2 || $2[19] !== t13 ? (t14 = {
    version: 0,
    focusedElement: t13,
    level: 0,
    path,
    ...
    space,
    state: state2
  }, $2[17] = space, $2[18] = state2, $2[19] = t13, $2[20] = t14) : t14 = $2[20], t12 = t14;
...
var TreeItem = (0, import_react53.memo)(function(props) {
  ...
  const content = (0, import_jsx_runtime13.jsxs)(Flex, { padding, children: [
  ...
  return href ? (0, import_jsx_runtime13.jsxs)(StyledTreeItem, { "data-selected": selected ? "" : void 0, "data-tree-id": id3, "data-tree-key": itemKey, "data-ui": "TreeItem", ...restProps, onClick: handleClick, ref: rootRef, role: "none", children: [
    (0, import_jsx_runtime13.jsx)(TreeItemBox, { $level: tree.level, "aria-expanded": expanded, as: linkAs, "data-ui": "TreeItem__box", href, ref: treeitemRef, role: "treeitem", tabIndex, children: content }),
    ...
    (0, import_jsx_runtime13.jsx)(TreeItemBox, { $level: tree.level, as: "div", "data-ui": "TreeItem__box", children: content }),
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BX3GKHXX.js.map
