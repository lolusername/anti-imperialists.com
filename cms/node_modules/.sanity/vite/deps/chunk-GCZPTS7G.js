...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources5-V45TYUHG.js")
});
...
function PaneItemPreview(props) {
  ...
  let t0, t1;
  $[0] !== perspectiveStack || $[1] !== props.documentPreviewStore || $[2] !== releasesIds || $[3] !== schemaType || $[4] !== title || $[5] !== value._id ? (t1 = getPreviewStateObservable$1(props.documentPreviewStore, schemaType, value._id, title, {
    ids: releasesIds,
    stack: perspectiveStack
  }), $[0] = perspectiveStack, $[1] = props.documentPreviewStore, $[2] = releasesIds, $[3] = schemaType, $[4] = title, $[5] = value._id, $[6] = t1) : t1 = $[6], t0 = t1;
  const previewStateObservable = t0;
  let t2;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t2 = {}, $[7] = t2) : t2 = $[7];
  let t3;
  $[8] !== selectedPerspectiveName ? (t3 = {
    draft: null,
    isLoading: true,
    published: null,
    version: null,
    versions: t2,
    selectedPerspectiveName
  }, $[8] = selectedPerspectiveName, $[9] = t3) : t3 = $[9];
  const {
    draft,
    published,
    version,
  ...
  } = useObservable(previewStateObservable, t3), isLoading = previewIsLoading || loading;
  let t4;
  $[10] !== draft || $[11] !== isLoading || $[12] !== presence || $[13] !== published || $[14] !== versions ? (t4 = isLoading ? null : (0, import_jsx_runtime.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, children: [
    presence && presence.length > 0 && (0, import_jsx_runtime.jsx)(DocumentPreviewPresence, { presence }),
    (0, import_jsx_runtime.jsx)(DocumentStatusIndicator, { draft, published, versions })
  ] }) }), $[10] = draft, $[11] = isLoading, $[12] = presence, $[13] = published, $[14] = versions, $[15] = t4) : t4 = $[15];
  const status = t4;
  let t5;
  $[16] !== draft || $[17] !== published || $[18] !== versions ? (t5 = (0, import_jsx_runtime.jsx)(DocumentStatus, { draft, published, versions }), $[16] = draft, $[17] = published, $[18] = versions, $[19] = t5) : t5 = $[19];
  const tooltip = t5;
  let t6;
  $[20] !== draft || $[21] !== published || $[22] !== selectedPerspectiveName || $[23] !== value || $[24] !== version ? (t6 = getPreviewValueWithFallback({
    value,
    draft,
    published,
    version,
    perspective: selectedPerspectiveName
  }), $[20] = draft, $[21] = published, $[22] = selectedPerspectiveName, $[23] = value, $[24] = version, $[25] = t6) : t6 = $[25];
  let t7;
  return $[26] !== icon || $[27] !== isLoading || $[28] !== layout || $[29] !== status || $[30] !== t6 || $[31] !== tooltip ? (t7 = (0, import_jsx_runtime.jsx)(SanityDefaultPreview, { ...t6, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[26] = icon, $[27] = isLoading, $[28] = layout, $[29] = status, $[30] = t6, $[31] = tooltip, $[32] = t7) : t7 = $[32], t7;
}
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      (0, import_jsx_runtime.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
        (0, import_jsx_runtime.jsxs)(Table$1, { children: [
          ...
          (0, import_jsx_runtime.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$l).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
            ...
            return (0, import_jsx_runtime.jsxs)("tr", { children: [
              ...
              (0, import_jsx_runtime.jsx)("td", { children: (0, import_jsx_runtime.jsxs)(DocumentIdFlex, { align: "center", gap: 2, justify: "flex-end", children: [
                ...
                documentId && (0, import_jsx_runtime.jsx)(Button2, { mode: "bleed", icon: CopyIcon, tooltipProps: {
...
function useReferringDocuments(documentId) {
  ...
  let t5;
  $[8] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t5 = () => Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp$k).filter(Boolean))).sort(), $[8] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 ? (t6 = t5(), $[10] = t5, $[11] = t6) : t6 = $[11];
  const projectIds = t6;
  let t7, t8;
  $[12] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t8 = Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp2$8).filter(_temp3$2))).sort(), $[12] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[13] = t8) : t8 = $[13], t7 = t8;
...
function _temp$k(crossDatasetReference) {
...
function PaneDivider(t0) {
  ...
  let t4;
  return $[3] !== handleMouseDown || $[4] !== t2 || $[5] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Root$9, { "data-disabled": t2, "data-dragging": t3, onMouseDown: handleMouseDown }), $[3] = handleMouseDown, $[4] = t2, $[5] = t3, $[6] = t4) : t4 = $[6], t4;
}
var Root$8 = dt(Card)`
  outline: none;
...
var Pane = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  }, t6 = [currentMinWidthProp, currentMaxWidthProp, flexProp, id, minWidthProp, maxWidthProp, mount, rootElement], $[18] = currentMaxWidthProp, $[19] = currentMinWidthProp, $[20] = flexProp, $[21] = id, $[22] = maxWidthProp, $[23] = minWidthProp, $[24] = mount, $[25] = rootElement, $[26] = t5, $[27] = t6) : (t5 = $[26], t6 = $[27]), (0, import_react.useLayoutEffect)(t5, t6);
  let t7;
  ...
  let t25;
  $[66] !== hidden || $[67] !== id || $[68] !== paneIndex || $[69] !== restProps || $[70] !== style || $[71] !== t19 || $[72] !== t20 || $[73] !== t21 || $[74] !== t22 || $[75] !== t24 ? (t25 = (0, import_jsx_runtime.jsxs)(Root$8, { "data-testid": "pane", "data-ui": "Pane", tone: "inherit", hidden, id, overflow: t19, ...restProps, "data-pane-collapsed": t20, "data-pane-index": paneIndex, "data-pane-selected": t21, ref: setRef, style, children: [
    t22,
    t24
...
function PaneContextMenuItem(props) {
  ...
  let t5;
  $[4] !== node.icon || $[5] !== node.onAction || $[6] !== node.selected || $[7] !== node.tone || $[8] !== t1 || $[9] !== t2 || $[10] !== t3 || $[11] !== t4 || $[12] !== title ? (t5 = (0, import_jsx_runtime.jsx)(MenuItem2, { disabled: t1, hotkeys: t2, icon: node.icon, iconRight: t3, onClick: node.onAction, pressed: node.selected, text: title, tone: node.tone, "data-testid": t4 }), $[4] = node.icon, $[5] = node.onAction, $[6] = node.selected, $[7] = node.tone, $[8] = t1, $[9] = t2, $[10] = t3, $[11] = t4, $[12] = title, $[13] = t5) : t5 = $[13];
  let t6;
  return $[14] !== t5 || $[15] !== tooltipContent ? (t6 = (0, import_jsx_runtime.jsx)(TooltipOfDisabled, { content: tooltipContent, placement: "left", children: t5 }), $[14] = t5, $[15] = tooltipContent, $[16] = t6) : t6 = $[16], t6;
}
...
var PaneFooter = (0, import_react.forwardRef)(function(props, ref) {
  ...
  let t1;
  return $[3] !== collapsed || $[4] !== ref || $[5] !== t0 ? (t1 = (0, import_jsx_runtime.jsx)(LegacyLayerProvider, { zOffset: "paneFooter", children: (0, import_jsx_runtime.jsx)(Root$6, { "data-testid": "pane-footer", hidden: collapsed, ref, children: t0 }) }), $[3] = collapsed, $[4] = ref, $[5] = t0, $[6] = t1) : t1 = $[6], t1;
});
var Root$5 = dt(Layer)(({
  $border
}) => lt`
...
var PaneHeader$1 = (0, import_react.forwardRef)(function(props, ref) {
  ...
  const handleLayoutClick = t4, showTabsOrSubActions = !!(!collapsed && (tabs || subActions)), t5 = collapsed ? "" : void 0, t6 = collapsed ? "" : void 0, t7 = collapsed || !showTabsOrSubActions ? 3 : 2;
  let t8;
  ...
  let t10;
  $[10] !== loading ? (t10 = loading && (0, import_jsx_runtime.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime.jsx)(TitleTextSkeleton, { animated: true, radius: 1, size: 1 }) }), $[10] = loading, $[11] = t10) : t10 = $[11];
  let t11;
  ...
  let t12;
  $[15] !== handleTitleClick || $[16] !== t10 || $[17] !== t11 || $[18] !== t9 || $[19] !== tabIndex ? (t12 = (0, import_jsx_runtime.jsxs)(TitleCard, { __unstable_focusRing: true, flex: 1, onClick: handleTitleClick, paddingLeft: t9, padding: 2, tabIndex, children: [
    t10,
    t11
  ] }), $[15] = handleTitleClick, $[16] = t10, $[17] = t11, $[18] = t9, $[19] = tabIndex, $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== actions || $[22] !== collapsed ? (t13 = actions && (0, import_jsx_runtime.jsx)(Box, { hidden: collapsed, children: (0, import_jsx_runtime.jsx)(LegacyLayerProvider, { zOffset: "paneHeader", children: actions }) }), $[21] = actions, $[22] = collapsed, $[23] = t13) : t13 = $[23];
  let t14;
  ...
  let t18;
  return $[41] !== border || $[42] !== ref || $[43] !== t17 || $[44] !== t5 ? (t18 = (0, import_jsx_runtime.jsx)(LayerProvider, { zOffset: 100, children: (0, import_jsx_runtime.jsx)(Root$5, { $border: border, "data-collapsed": t5, "data-testid": "pane-header", ref, children: t17 }) }), $[41] = border, $[42] = ref, $[43] = t17, $[44] = t5, $[45] = t18) : t18 = $[45], t18;
});
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react.useState)(_temp$j), [rootElement, setRootElement] = (0, import_react.useState)(null), width = ((_a = useElementRect(rootElement)) == null ? void 0 : _a.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
  ...
  }, t8 = [collapsed, onCollapse, onExpand], $[18] = collapsed, $[19] = onCollapse, $[20] = onExpand, $[21] = t7, $[22] = t8) : (t7 = $[21], t8 = $[22]), (0, import_react.useEffect)(t7, t8);
  let t9, t10;
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(Root$4, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
  return $[38] !== paneLayout || $[39] !== t14 ? (t15 = (0, import_jsx_runtime.jsx)(PaneLayoutContext.Provider, { value: paneLayout, children: t14 }), $[38] = paneLayout, $[39] = t14, $[40] = t15) : t15 = $[40], t15;
}
function _temp$j() {
...
var IntentButton = (0, import_react.forwardRef)(function(props, ref) {
  ...
  let t0, t1;
  $[3] !== intent.params || $[4] !== intent.searchParams || $[5] !== intent.type ? (t1 = (0, import_react.forwardRef)(function(linkProps, linkRef) {
    return (0, import_jsx_runtime.jsx)(IntentLink, { ...linkProps, intent: intent.type, params: intent.params, ref: linkRef, searchParams: intent.searchParams });
  }), $[3] = intent.params, $[4] = intent.searchParams, $[5] = intent.type, $[6] = t1) : t1 = $[6], t0 = t1;
  const Link = t0;
  let t2;
  return $[7] !== Link || $[8] !== props.disabled || $[9] !== ref || $[10] !== restProps ? (t2 = props.disabled ? (0, import_jsx_runtime.jsx)(Button2, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : (0, import_jsx_runtime.jsx)(Button2, { ...restProps, as: Link, "data-as": "a", ref }), $[7] = Link, $[8] = props.disabled, $[9] = ref, $[10] = restProps, $[11] = t2) : t2 = $[11], t2;
});
...
function PaneHeaderCreateButton(t0) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(63), {
    templateItems
  ...
  let t3;
  t3 = !isTemplatePermissionsLoading && (templatePermissions == null ? void 0 : templatePermissions.every(_temp$i));
  ...
  if (templateItems.length === 1) {
    ...
    let t82;
    $[22] !== disabled || $[23] !== t || $[24] !== tCore ? (t82 = disabled ? {
      content: tCore("new-document.disabled-release.tooltip")
    } : {
      content: t("pane-header.create-new-button.tooltip")
    }, $[22] = disabled, $[23] = t, $[24] = tCore, $[25] = t82) : t82 = $[25];
    let t92;
    $[26] !== disabled || $[27] !== intent || $[28] !== t62.title || $[29] !== t72 || $[30] !== t82 ? (t92 = (0, import_jsx_runtime.jsx)(IntentButton, { "aria-label": t62.title, icon: t72, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t82 }), $[26] = disabled, $[27] = intent, $[28] = t62.title, $[29] = t72, $[30] = t82, $[31] = t92) : t92 = $[31];
    let t102;
    return $[32] !== disabled || $[33] !== isTemplatePermissionsLoading || $[34] !== t92 ? (t102 = (0, import_jsx_runtime.jsx)(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t92 }), $[32] = disabled, $[33] = isTemplatePermissionsLoading, $[34] = t92, $[35] = t102) : t102 = $[35], t102;
  }
  const t5 = !isReleaseActive;
  let t6;
  $[36] !== isReleaseActive || $[37] !== t || $[38] !== tCore ? (t6 = isReleaseActive ? {
    content: t("pane-header.create-new-button.tooltip")
  } : {
    content: tCore("new-document.disabled-release.tooltip")
  }, $[36] = isReleaseActive, $[37] = t, $[38] = tCore, $[39] = t6) : t6 = $[39];
  let t7;
  $[40] !== t5 || $[41] !== t6 ? (t7 = (0, import_jsx_runtime.jsx)(Button2, { icon: AddIcon, mode: "bleed", disabled: t5, "data-testid": "multi-action-intent-button", tooltipProps: t6 }), $[40] = t5, $[41] = t6, $[42] = t7) : t7 = $[42];
  let t8;
  if ($[43] !== getI18nText || $[44] !== isTemplatePermissionsLoading || $[45] !== permissionsById || $[46] !== selectedReleaseId || $[47] !== t || $[48] !== templateItems || $[49] !== templates) {
    let t92;
    $[51] !== getI18nText || $[52] !== isTemplatePermissionsLoading || $[53] !== permissionsById || $[54] !== selectedReleaseId || $[55] !== t || $[56] !== templates ? (t92 = (item, itemIndex) => {
      var _a2;
      ...
      if (!template || !intent_0)
        return null;
      const Link = (0, import_react.forwardRef)((linkProps, linkRef) => disabled_0 ? (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: true, ...linkProps, ref: linkRef }) : (0, import_jsx_runtime.jsx)(IntentLink, { ...linkProps, intent: intent_0.type, params: intent_0.params, searchParams: intent_0.searchParams, ref: linkRef }));
      ...
      return (0, import_jsx_runtime.jsx)(InsufficientPermissionsMessageTooltip, { context: "create-document-type", reveal: disabled_0, loading: isTemplatePermissionsLoading, children: (0, import_jsx_runtime.jsx)(MenuItem2, { as: Link, "data-as": disabled_0 ? "button" : "a", text: title, "aria-label": disabled_0 ? t("pane-header.disabled-created-button.aria-label") : title, disabled: disabled_0, "data-testid": `action-intent-button-${itemIndex}` }) }, item.id);
    }, $[51] = getI18nText, $[52] = isTemplatePermissionsLoading, $[53] = permissionsById, $[54] = selectedReleaseId, $[55] = t, $[56] = templates, $[57] = t92) : t92 = $[57], t8 = templateItems.map(t92), $[43] = getI18nText, $[44] = isTemplatePermissionsLoading, $[45] = permissionsById, $[46] = selectedReleaseId, $[47] = t, $[48] = templateItems, $[49] = templates, $[50] = t8;
  } else
    t8 = $[50];
  let t9;
  $[58] !== t8 ? (t9 = (0, import_jsx_runtime.jsx)(Menu, { children: t8 }), $[58] = t8, $[59] = t9) : t9 = $[59];
  let t10;
  return $[60] !== t7 || $[61] !== t9 ? (t10 = (0, import_jsx_runtime.jsx)(MenuButton, { button: t7, id: "create-menu", menu: t9, popover: POPOVER_PROPS }), $[60] = t7, $[61] = t9, $[62] = t10) : t10 = $[62], t10;
}
function _temp2$7(acc, permission_0) {
  return acc[permission_0.id] = permission_0, acc;
}
function _temp$i(permission) {
...
var PaneHeaderActions = (0, import_react.memo)(function(props) {
  const {
    initialValueTemplateItems: initialValueTemplateItemsFromStructure = EMPTY_ARRAY$C,
    menuItems = EMPTY_ARRAY$C,
    menuItemGroups = EMPTY_ARRAY$C,
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$h, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$h() {
...
function PaneItem(props) {
  ...
  let t4;
  $[22] !== selected ? (t4 = [selected], $[22] = selected, $[23] = t4) : t4 = $[23], (0, import_react.useEffect)(t3, t4);
  const [preloading, setPreload] = (0, import_react.useState)(false), timeoutRef = (0, import_react.useRef)(null);
  let t5;
  $[24] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => {
    timeoutRef.current = setTimeout(() => (0, import_react.startTransition)(() => setPreload(true)), 400);
  }, $[24] = t5) : t5 = $[24];
  const handleMouseEnter = t5;
  let t6;
  $[25] === Symbol.for("react.memo_cache_sentinel") ? (t6 = () => {
    timeoutRef.current && clearTimeout(timeoutRef.current), (0, import_react.startTransition)(() => setPreload(false));
  }, $[25] = t6) : t6 = $[25];
  const handleMouseLeave = t6, t7 = `pane-item-${title}`, t8 = ChildLink2, t9 = selected || clicked;
  let t10;
  $[26] !== id || $[27] !== preloading || $[28] !== schemaType || $[29] !== value ? (t10 = preloading && (schemaType == null ? void 0 : schemaType.name) && value && isSanityDocument(value) && (0, import_jsx_runtime.jsx)(PreloadDocumentPane, { documentId: id, documentType: schemaType.name }), $[26] = id, $[27] = preloading, $[28] = schemaType, $[29] = value, $[30] = t10) : t10 = $[30];
  let t11;
  return $[31] !== id || $[32] !== margin || $[33] !== marginBottom || $[34] !== marginTop || $[35] !== pressed || $[36] !== preview || $[37] !== t10 || $[38] !== t7 || $[39] !== t8 || $[40] !== t9 ? (t11 = (0, import_jsx_runtime.jsxs)(PreviewCard, { "data-testid": t7, __unstable_focusRing: true, as: t8, childId: id, "data-as": "a", margin, marginBottom, marginTop, onClick: handleClick, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, pressed, radius: 2, selected: t9, sizing: "border", tabIndex: -1, tone: "inherit", children: [
    preview,
    t10
...
function PreloadDocumentPane(props) {
  ...
  return useEditState(documentId, documentType), null;
}
...
var LoadingPane = (0, import_react.memo)((props) => {
  ...
  let t11;
  $[15] !== t10 || $[16] !== t8 ? (t11 = (0, import_jsx_runtime.jsx)(Content$2, { align: "center", "data-mounted": t8, direction: "column", height: "fill", justify: "center", ref: setContentElement, children: t10 }), $[15] = t10, $[16] = t8, $[17] = t11) : t11 = $[17];
  const content = t11;
  let t12;
...
function DocumentInspectorMenuItemsResolver(props) {
  const {
    ...
    onMenuItems
  } = props, len = inspectors2.length, [menuItems, setMenuItems] = (0, import_react.useState)(() => Array.from(new Array(len)));
...
function DocumentInspectorHeader(props) {
  ...
  let t5;
  return $[20] !== children || $[21] !== forwardedAs || $[22] !== restProps || $[23] !== t4 ? (t5 = (0, import_jsx_runtime.jsxs)(Root$3, { ...restProps, as: forwardedAs, children: [
    t4,
    children
...
function DocumentInspectorPanel(props) {
  ...
  let t1;
  $[3] !== Component || $[4] !== documentId || $[5] !== documentType || $[6] !== handleClose ? (t1 = (0, import_jsx_runtime.jsx)(Component, { onClose: handleClose, documentId, documentType }), $[3] = Component, $[4] = documentId, $[5] = documentType, $[6] = handleClose, $[7] = t1) : t1 = $[7];
  const element = t1;
  if (features.resizablePanes) {
    let t22;
    return $[8] !== element || $[9] !== flex ? (t22 = (0, import_jsx_runtime.jsx)(Resizable, { as: "aside", "data-ui": "DocumentInspectorPanel", flex, resizerPosition: "left", maxWidth: DOCUMENT_INSPECTOR_MAX_WIDTH, minWidth: DOCUMENT_INSPECTOR_MIN_WIDTH, children: element }), $[8] = element, $[9] = flex, $[10] = t22) : t22 = $[10], t22;
  }
  let t2;
...
function InspectDialog(props) {
  ...
  let t20;
  $[30] !== value || $[31] !== viewMode ? (t20 = viewMode === VIEW_MODE_PARSED && (0, import_jsx_runtime.jsx)(JSONInspectorWrapper, { children: (0, import_jsx_runtime.jsx)(JsonInspector, { data: value, isExpanded, onClick: toggleExpanded, search: Search, filterOptions: {
    ignoreCase: true
...
function Banner(props) {
  ...
  let t2;
  $[7] !== Icon ? (t2 = Icon && (0, import_jsx_runtime.jsx)(Text, { size: 0, children: (0, import_jsx_runtime.jsx)(Icon, {}) }), $[7] = Icon, $[8] = t2) : t2 = $[8];
  let t3;
  $[9] !== content ? (t3 = (0, import_jsx_runtime.jsx)(Flex, { align: "center", flex: 1, gap: 2, paddingY: 3, children: content }), $[9] = content, $[10] = t3) : t3 = $[10];
  let t4;
  $[11] !== action ? (t4 = action && (0, import_jsx_runtime.jsx)(Button2, { ...action, mode: action.mode || "ghost", tone: action.tone || "default" }), $[11] = action, $[12] = t4) : t4 = $[12];
  let t5;
  $[13] !== t2 || $[14] !== t3 || $[15] !== t4 ? (t5 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, children: [
    t2,
    t3,
    t4
  ] }), $[13] = t2, $[14] = t3, $[15] = t4, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== paddingY || $[18] !== rest || $[19] !== t5 || $[20] !== tone ? (t6 = (0, import_jsx_runtime.jsx)(Card, { borderBottom: true, paddingX: 4, paddingY, tone, ...rest, children: t5 }), $[17] = paddingY, $[18] = rest, $[19] = t5, $[20] = tone, $[21] = t6) : t6 = $[21], t6;
}
function DeletedDocumentBanners() {
  ...
  if (!isPublishedPerspective(selectedPerspective) && !isDraftPerspective(selectedPerspective) && selectedPerspective.state === "archived") {
    ...
    let t1;
    return $[0] !== t0 ? (t1 = (0, import_jsx_runtime.jsx)(ArchivedReleaseBanner, { release: t0 }), $[0] = t0, $[1] = t1) : t1 = $[1], t1;
  }
  if (isDeleted && !isDeleting) {
    let t0;
    return $[2] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime.jsx)(DeletedDocumentBanner, {}), $[2] = t0) : t0 = $[2], t0;
  }
}
function DeletedDocumentBanner() {
  ...
  let t3;
  $[12] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: t2 }), $[12] = t2, $[13] = t3) : t3 = $[13];
  let t4;
  return $[14] !== t1 || $[15] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Banner, { action: t1, content: t3, "data-testid": "deleted-document-banner", icon: ReadOnlyIcon }), $[14] = t1, $[15] = t3, $[16] = t4) : t4 = $[16], t4;
}
var ArchivedReleaseBanner = (t0) => {
  ...
  const $ = (0, import_react_compiler_runtime.c)(5), {
    ...
    t
  } = useTranslation2(), t1 = (_a = release.metadata) == null ? void 0 : _a.title;
  let t2;
  $[0] !== t1 ? (t2 = {
    title: t1
  }, $[0] = t1, $[1] = t2) : t2 = $[1];
  let t3;
  return $[2] !== t || $[3] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(Banner, { tone: "caution", content: (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "banners.deleted-release-banner.text", values: t2 }) }), "data-testid": "deleted-release-banner", icon: DocumentRemoveIcon }), $[2] = t, $[3] = t2, $[4] = t3) : t3 = $[4], t3;
};
...
function AddToReleaseBanner(t0) {
  ...
  let t3;
  $[2] !== createVersion || $[3] !== currentRelease._id || $[4] !== documentId || $[5] !== value ? (t3 = async () => {
    currentRelease._id && await createVersion(getReleaseIdFromReleaseDocumentId(currentRelease._id), documentId, value);
  }, $[2] = createVersion, $[3] = currentRelease._id, $[4] = documentId, $[5] = value, $[6] = t3) : t3 = $[6];
  const handleAddToRelease = t3;
  let t4;
  $[7] !== ((_a = currentRelease.metadata) == null ? void 0 : _a.title) || $[8] !== tCore ? (t4 = ((_b = currentRelease == null ? void 0 : currentRelease.metadata) == null ? void 0 : _b.title) || tCore("release.placeholder-untitled-release"), $[7] = (_c = currentRelease.metadata) == null ? void 0 : _c.title, $[8] = tCore, $[9] = t4) : t4 = $[9];
  let t5;
  $[10] !== t4 ? (t5 = {
    title: t4
  }, $[10] = t4, $[11] = t5) : t5 = $[11];
  let t6;
  $[12] !== currentRelease ? (t6 = getVersionInlineBadge(currentRelease), $[12] = currentRelease, $[13] = t6) : t6 = $[13];
  let t7;
  $[14] !== t6 ? (t7 = {
    VersionBadge: t6
  }, $[14] = t6, $[15] = t7) : t7 = $[15];
  let t8;
  $[16] !== t || $[17] !== t5 || $[18] !== t7 ? (t8 = (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Translate, { i18nKey: "banners.release.not-in-release", t, values: t5, components: t7 }) }), $[16] = t, $[17] = t5, $[18] = t7, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== t ? (t9 = t("banners.release.action.add-to-release"), $[20] = t, $[21] = t9) : t9 = $[21];
  let t10;
  $[22] !== handleAddToRelease || $[23] !== t9 || $[24] !== tone ? (t10 = (0, import_jsx_runtime.jsx)(Button2, { text: t9, tone, onClick: handleAddToRelease }), $[22] = handleAddToRelease, $[23] = t9, $[24] = tone, $[25] = t10) : t10 = $[25];
  let t11;
  $[26] !== t10 || $[27] !== t8 ? (t11 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: [
    t8,
    t10
  ] }), $[26] = t10, $[27] = t8, $[28] = t11) : t11 = $[28];
  let t12;
  return $[29] !== t11 || $[30] !== tone ? (t12 = (0, import_jsx_runtime.jsx)(Banner, { tone, paddingY: 0, content: t11 }), $[29] = t11, $[30] = tone, $[31] = t12) : t12 = $[31], t12;
}
function ArchivedReleaseDocumentBanner() {
  ...
  }, release = (0, import_react.useMemo)(() => archivedReleases.find((r) => getReleaseIdFromReleaseDocumentId(r._id) === (params == null ? void 0 : params.historyVersion)), [archivedReleases, params == null ? void 0 : params.historyVersion]), description = (release == null ? void 0 : release.state) === "published" ? "banners.published-release.description" : "banners.archived-release.description", title = (release == null ? void 0 : release.metadata.title) || tCore("release.placeholder-untitled-release");
  return (0, import_jsx_runtime.jsx)(Banner, { tone: "caution", paddingY: 2, content: (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: description, values: {
    title
  }, components: {
...
function DraftLiveEditBanner(t0) {
  ...
  let t14;
  return $[34] !== t13 || $[35] !== t5 || $[36] !== t9 ? (t14 = (0, import_jsx_runtime.jsx)(Banner, { paddingY: 0, content: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", justify: "space-between", gap: 2, paddingTop: 1, children: [
    t5,
    t9,
    t13
...
function ScheduledReleaseBanner(t0) {
  ...
  let t3;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t3 = (0, import_jsx_runtime.jsx)(LockIcon, {}), $[2] = t3) : t3 = $[2];
  let t4;
  ...
  let t6;
  $[7] !== t5 || $[8] !== tCore ? (t6 = (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", justify: "center", gap: 2, children: [
    t3,
    " ",
    (0, import_jsx_runtime.jsx)(Translate, { t: tCore, i18nKey: "release.banner.scheduled-for-publishing-on", values: t5 })
  ] }) }) }), $[7] = t5, $[8] = tCore, $[9] = t6) : t6 = $[9];
  let t7;
  return $[10] !== t6 || $[11] !== tone ? (t7 = (0, import_jsx_runtime.jsx)(Banner, { tone, paddingY: 0, content: t6 }), $[10] = t6, $[11] = tone, $[12] = t7) : t7 = $[12], t7;
}
function UnpublishedDocumentBanner() {
  ...
  if (isReleaseDocument(selectedPerspective) && willBeUnpublished) {
    ...
    let t4;
    return $[9] !== t || $[10] !== t1 || $[11] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Banner, { tone: "critical", content: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "banners.unpublished-release-banner.text", values: t1, components: t3 }) }), icon: UnpublishIcon }), $[9] = t, $[10] = t1, $[11] = t3, $[12] = t4) : t4 = $[12], t4;
  }
  return null;
}
...
var FormView = (0, import_react.forwardRef)(function(props, ref) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(73), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react.useState)(_temp$e), isLocked = (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled, {
    t
  } = useTranslation2(structureLocaleNamespace);
  let t0, t1;
  ...
  let t5;
  $[14] !== documentId || $[15] !== documentStore || $[16] !== documentType || $[17] !== patchChannel || $[18] !== selectedReleaseId ? (t5 = [documentId, documentStore, documentType, patchChannel, selectedReleaseId], $[14] = documentId, $[15] = documentStore, $[16] = documentType, $[17] = patchChannel, $[18] = selectedReleaseId, $[19] = t5) : t5 = $[19], (0, import_react.useEffect)(t4, t5);
  ...
  let t8;
  $[26] !== hasRev ? (t8 = [hasRev], $[26] = hasRev, $[27] = t8) : t8 = $[27], (0, import_react.useEffect)(t7, t8);
  ...
  let t11;
  $[33] !== focusedFirstDescendant || $[34] !== formRef || $[35] !== ready || $[36] !== t10 ? (t11 = [focusedFirstDescendant, formRef, t10, ready], $[33] = focusedFirstDescendant, $[34] = formRef, $[35] = ready, $[36] = t10, $[37] = t11) : t11 = $[37], (0, import_react.useEffect)(t9, t11);
  let t12;
  $[38] !== ref ? (t12 = (node) => {
  ...
  let t14;
  $[64] !== setRef || $[65] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: t13 }), $[64] = setRef, $[65] = t13, $[66] = t14) : t14 = $[66];
  let t15;
  $[67] !== margins || $[68] !== t14 ? (t15 = (0, import_jsx_runtime.jsx)(PresenceOverlay, { margins, children: t14 }), $[67] = margins, $[68] = t14, $[69] = t15) : t15 = $[69];
  let t16;
  return $[70] !== hidden || $[71] !== t15 ? (t16 = (0, import_jsx_runtime.jsx)(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[70] = hidden, $[71] = t15, $[72] = t16) : t16 = $[72], t16;
});
...
var DocumentPanel = function(props) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(71), {
    footerHeight,
    headerHeight,
    isInspectOpen,
    rootElement,
    ...
    features
  } = useStructureTool(), [_portalElement, setPortalElement] = (0, import_react.useState)(null), [documentScrollElement, setDocumentScrollElement] = (0, import_react.useState)(null), formContainerElement = (0, import_react.useRef)(null), requiredPermission = value._createdAt ? "update" : "create";
  let t0, t1;
  $[0] !== activeViewId || $[1] !== views2 ? (t1 = views2.find((view) => view.id === activeViewId) || views2[0] || {
    type: "form"
  }, $[0] = activeViewId, $[1] = views2, $[2] = t1) : t1 = $[2], t0 = t1;
  ...
  bb0: {
    if (layoutCollapsed) {
      ...
      let t52;
      $[3] !== t33 || $[4] !== t42 ? (t52 = [t33, 0, t42, 0], $[3] = t33, $[4] = t42, $[5] = t52) : t52 = $[5], t2 = t52;
      break bb0;
    }
    let t32;
    $[6] === Symbol.for("react.memo_cache_sentinel") ? (t32 = [0, 0, 2, 0], $[6] = t32) : t32 = $[6], t2 = t32;
  }
  const margins = t2, formViewHidden = activeView.type !== "form";
  let t3;
  $[7] !== activeView.component || $[8] !== activeView.options || $[9] !== activeView.type || $[10] !== displayed || $[11] !== documentId || $[12] !== (editState == null ? void 0 : editState.draft) || $[13] !== (editState == null ? void 0 : editState.published) || $[14] !== schemaType || $[15] !== value ? (t3 = () => {
    if (activeView.type === "component" && activeView.component) {
      const ActiveViewComponent = activeView.component;
      return (0, import_jsx_runtime.jsx)(ActiveViewComponent, { document: {
    ...
    return false;
  }, $[7] = activeView.component, $[8] = activeView.options, $[9] = activeView.type, $[10] = displayed, $[11] = documentId, $[12] = editState == null ? void 0 : editState.draft, $[13] = editState == null ? void 0 : editState.published, $[14] = schemaType, $[15] = value, $[16] = t3) : t3 = $[16];
  let t4;
  $[17] !== t3 ? (t4 = t3(), $[17] = t3, $[18] = t4) : t4 = $[18];
  const activeViewNode = t4, isLiveEdit = isLiveEditEnabled(schemaType);
  let t5;
  $[19] !== documentScrollElement ? (t5 = () => {
    (documentScrollElement == null ? void 0 : documentScrollElement.scrollTo) && documentScrollElement.scrollTo(0, 0);
  }, $[19] = documentScrollElement, $[20] = t5) : t5 = $[20];
  let t6;
  $[21] !== documentId || $[22] !== documentScrollElement ? (t6 = [documentId, documentScrollElement], $[21] = documentId, $[22] = documentScrollElement, $[23] = t6) : t6 = $[23], (0, import_react.useEffect)(t5, t6);
  let t7, t8;
  $[24] !== portalElement || $[25] !== setDocumentPanelPortalElement ? (t7 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t8 = [portalElement, setDocumentPanelPortalElement], $[24] = portalElement, $[25] = setDocumentPanelPortalElement, $[26] = t7, $[27] = t8) : (t7 = $[26], t8 = $[27]), (0, import_react.useEffect)(t7, t8);
  let t9, t10;
  $[28] !== displayed || $[29] !== isInspectOpen || $[30] !== value ? (t10 = isInspectOpen ? (0, import_jsx_runtime.jsx)(InspectDialog, { value: displayed || value }) : null, $[28] = displayed, $[29] = isInspectOpen, $[30] = value, $[31] = t10) : t10 = $[31], t9 = t10;
  ...
  bb1: {
    if (params == null ? void 0 : params.historyVersion) {
      let t123;
      $[32] === Symbol.for("react.memo_cache_sentinel") ? (t123 = (0, import_jsx_runtime.jsx)(ArchivedReleaseDocumentBanner, {}), $[32] = t123) : t123 = $[32], t11 = t123;
      break bb1;
    }
    const isCreatingDocument = displayed && !displayed._createdAt;
    if (isReleaseDocument(selectedPerspective) && isReleaseScheduledOrScheduling(selectedPerspective)) {
      const t123 = selectedPerspective;
      let t133;
      $[33] !== t123 ? (t133 = (0, import_jsx_runtime.jsx)(ScheduledReleaseBanner, { currentRelease: t123 }), $[33] = t123, $[34] = t133) : t133 = $[34], t11 = t133;
      break bb1;
    }
    if ((displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isCreatingDocument) {
      const t123 = selectedPerspective, t133 = displayed || void 0;
      let t143;
      $[35] !== t123 || $[36] !== t133 || $[37] !== value._id ? (t143 = (0, import_jsx_runtime.jsx)(AddToReleaseBanner, { documentId: value._id, currentRelease: t123, value: t133 }), $[35] = t123, $[36] = t133, $[37] = value._id, $[38] = t143) : t143 = $[38], t11 = t143;
      break bb1;
    }
    if (activeView.type === "form" && isLiveEdit && ready && ((_a = editState == null ? void 0 : editState.draft) == null ? void 0 : _a._id) && !selectedReleaseId) {
      let t123;
      $[39] !== displayed || $[40] !== documentId || $[41] !== schemaType ? (t123 = (0, import_jsx_runtime.jsx)(DraftLiveEditBanner, { displayed, documentId, schemaType }), $[39] = displayed, $[40] = documentId, $[41] = schemaType, $[42] = t123) : t123 = $[42], t11 = t123;
      break bb1;
    }
    ...
    let t122;
    $[43] !== (permissions == null ? void 0 : permissions.granted) || $[44] !== requiredPermission ? (t122 = !(permissions == null ? void 0 : permissions.granted) && (0, import_jsx_runtime.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[43] = permissions == null ? void 0 : permissions.granted, $[44] = requiredPermission, $[45] = t122) : t122 = $[45];
    let t132, t142, t15, t16;
    $[46] === Symbol.for("react.memo_cache_sentinel") ? (t132 = (0, import_jsx_runtime.jsx)(ReferenceChangedBanner, {}), t142 = (0, import_jsx_runtime.jsx)(DeprecatedDocumentTypeBanner, {}), t15 = (0, import_jsx_runtime.jsx)(DeletedDocumentBanners, {}), t16 = (0, import_jsx_runtime.jsx)(UnpublishedDocumentBanner, {}), $[46] = t132, $[47] = t142, $[48] = t15, $[49] = t16) : (t132 = $[46], t142 = $[47], t15 = $[48], t16 = $[49]);
    let t17;
    $[50] !== t122 ? (t17 = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      t122,
      t132,
      t142,
      t15,
      t16
    ] }), $[50] = t122, $[51] = t17) : t17 = $[51], t11 = t17;
  }
  const banners = t11;
  let t12;
  $[52] !== activeViewNode || $[53] !== banners || $[54] !== documentScrollElement || $[55] !== features.resizablePanes || $[56] !== formViewHidden || $[57] !== inspectDialog || $[58] !== layoutCollapsed || $[59] !== margins || $[60] !== portalElement || $[61] !== showInspector ? (t12 = (features.resizablePanes || !showInspector) && (0, import_jsx_runtime.jsx)(DocumentBox, { flex: 2, overflow: "hidden", children: (0, import_jsx_runtime.jsx)(PortalProvider, { element: portalElement, __unstable_elements: {
    ...
    banners,
    (0, import_jsx_runtime.jsxs)(Scroller$4, { $disabled: layoutCollapsed || false, "data-testid": "document-panel-scroller", ref: setDocumentScrollElement, children: [
      (0, import_jsx_runtime.jsx)(FormView, { hidden: formViewHidden, margins, ref: formContainerElement }),
      activeViewNode
    ] }),
    inspectDialog,
    (0, import_jsx_runtime.jsx)("div", { "data-testid": "document-panel-portal", ref: setPortalElement })
  ] }) }) }) }), $[52] = activeViewNode, $[53] = banners, $[54] = documentScrollElement, $[55] = features.resizablePanes, $[56] = formViewHidden, $[57] = inspectDialog, $[58] = layoutCollapsed, $[59] = margins, $[60] = portalElement, $[61] = showInspector, $[62] = t12) : t12 = $[62];
  let t13;
  $[63] !== documentId || $[64] !== rootElement || $[65] !== schemaType || $[66] !== showInspector ? (t13 = showInspector && (0, import_jsx_runtime.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[63] = documentId, $[64] = rootElement, $[65] = schemaType, $[66] = showInspector, $[67] = t13) : t13 = $[67];
  let t14;
  return $[68] !== t12 || $[69] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(PaneContent, { children: (0, import_jsx_runtime.jsxs)(Flex, { height: "fill", children: [
    t12,
    t13
  ] }) }), $[68] = t12, $[69] = t13, $[70] = t14) : t14 = $[70], t14;
};
...
var DeleteAction = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(36), {
    ...
    delete: deleteOp
  } = useDocumentOperation(id, type, release), [isDeleting, setIsDeleting] = (0, import_react.useState)(false), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react.useState)(false), {
    t
  } = useTranslation2(structureLocaleNamespace);
  let t1;
  $[0] !== onComplete ? (t1 = () => {
  ...
  bb0: {
    if (!isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted)) {
      ...
      let t72;
      $[13] !== currentUser ? (t72 = (0, import_jsx_runtime.jsx)(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[13] = currentUser, $[14] = t72) : t72 = $[14];
      let t82;
      $[15] !== t62 || $[16] !== t72 ? (t82 = {
        tone: "critical",
        icon: TrashIcon,
...
var DiscardChangesAction = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(24), {
    ...
    discardChanges
  } = useDocumentOperation(id, type, release), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react.useState)(false);
  let t1;
  ...
  const dialog = t4;
  let t6;
  $[13] !== currentUser || $[14] !== dialog || $[15] !== discardChanges.disabled || $[16] !== isPermissionsLoading || $[17] !== liveEdit || $[18] !== (permissions == null ? void 0 : permissions.granted) || $[19] !== published || $[20] !== t ? (t6 = () => !published || liveEdit ? null : !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: true,
    ...
    onHandle: handle,
    dialog
  }, $[13] = currentUser, $[14] = dialog, $[15] = discardChanges.disabled, $[16] = isPermissionsLoading, $[17] = liveEdit, $[18] = permissions == null ? void 0 : permissions.granted, $[19] = published, $[20] = t, $[21] = t6) : t6 = $[21];
  let t7;
...
var DuplicateAction = (t0) => {
  ...
  bb0: {
    if (!isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted)) {
      ...
      let t52;
      $[13] !== currentUser ? (t52 = (0, import_jsx_runtime.jsx)(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[13] = currentUser, $[14] = t52) : t52 = $[14];
      let t62;
      $[15] !== t42 || $[16] !== t52 ? (t62 = {
        icon: CopyIcon,
        disabled: true,
...
var UnpublishAction = ({
  ...
  return (0, import_react.useMemo)(() => release || liveEdit ? null : !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
    ...
    dialog
  }, [release, currentUser, dialog, isPermissionsLoading, liveEdit, permissions == null ? void 0 : permissions.granted, t, unpublish.disabled]);
};
...
var DocumentStatusBarActionsInner = (0, import_react.memo)(function(props) {
  ...
  let t4;
  $[15] !== disabled || $[16] !== firstActionState || $[17] !== selectedReleaseId || $[18] !== tooltipContent ? (t4 = firstActionState && !selectedReleaseId && (0, import_jsx_runtime.jsx)(LayerProvider, { zOffset: 200, children: (0, import_jsx_runtime.jsx)(Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: (0, import_jsx_runtime.jsx)(Stack, { children: (0, import_jsx_runtime.jsx)(Button2, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, size: "large", text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[15] = disabled, $[16] = firstActionState, $[17] = selectedReleaseId, $[18] = tooltipContent, $[19] = t4) : t4 = $[19];
  let t5;
  $[20] !== disabled || $[21] !== menuActionStates || $[22] !== selectedReleaseId || $[23] !== showMenu || $[24] !== sideMenuItems ? (t5 = (showMenu && menuActionStates.length > 0 || selectedReleaseId) && (0, import_jsx_runtime.jsx)(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[20] = disabled, $[21] = menuActionStates, $[22] = selectedReleaseId, $[23] = showMenu, $[24] = sideMenuItems, $[25] = t5) : t5 = $[25];
  let t6;
  $[26] !== buttonElement || $[27] !== firstActionState ? (t6 = firstActionState && firstActionState.dialog && (0, import_jsx_runtime.jsx)(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[26] = buttonElement, $[27] = firstActionState, $[28] = t6) : t6 = $[28];
  let t7;
  return $[29] !== t3 || $[30] !== t4 || $[31] !== t5 || $[32] !== t6 ? (t7 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 1, children: [
    t3,
    t4,
    t5,
    t6
...
var TooltipContent$1 = (t0) => {
  ...
  if (release.metadata.releaseType === "asap") {
    let t1;
    $[0] !== t ? (t1 = t("release.type.asap"), $[0] = t, $[1] = t1) : t1 = $[1];
    let t2;
    return $[2] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(Text, { size: 1, children: t1 }), $[2] = t1, $[3] = t2) : t2 = $[3], t2;
  }
  if (release.metadata.releaseType === "scheduled") {
    const isActive = release.state === "active";
    let t1;
    return $[4] !== isActive || $[5] !== release || $[6] !== t ? (t1 = release.metadata.intendedPublishAt && (0, import_jsx_runtime.jsx)(Text, { size: 1, children: isActive ? (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "release.chip.tooltip.intended-for-date", values: {
      date: formatRelativeLocalePublishDate(release)
    } }) : (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "release.chip.tooltip.scheduled-for-date", values: {
      date: formatRelativeLocalePublishDate(release)
    } }) }), $[4] = isActive, $[5] = release, $[6] = t, $[7] = t1) : t1 = $[7], t1;
  }
  if (release.metadata.releaseType === "undecided") {
    let t1;
    $[8] !== t ? (t1 = t("release.type.undecided"), $[8] = t, $[9] = t1) : t1 = $[9];
    let t2;
    return $[10] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(Text, { size: 1, children: t1 }), $[10] = t1, $[11] = t2) : t2 = $[11], t2;
  }
  return null;
};
...
var DocumentPerspectiveList = (0, import_react.memo)(function() {
  ...
  const {
    ...
    data: archivedReleases
  } = useArchivedReleases(), schema = useSchema(), {
    editState,
    displayed,
    documentType,
    documentId
    ...
    documentId
  }), isCreatingDocument = displayed && !displayed._createdAt, filteredReleases = (0, import_react.useMemo)(() => {
    ...
    const archivedRelease = archivedReleases.find((r) => getReleaseIdFromReleaseDocumentId(r._id) === (params == null ? void 0 : params.historyVersion));
  ...
  }, [archivedReleases, isCreatingDocument, displayed == null ? void 0 : displayed._id, documentVersions, params == null ? void 0 : params.historyVersion, releases, selectedReleaseId]), handlePerspectiveChange = (0, import_react.useCallback)((perspective) => () => {
    setPerspective(perspective);
  }, [setPerspective]), schemaType = schema.get(documentType), isLiveEdit = schemaType ? isLiveEditEnabled(schemaType) : false, isPublishedChipDisabled = (0, import_react.useMemo)(() => isLiveEdit && !selectedReleaseId ? false : !(editState == null ? void 0 : editState.published), [isLiveEdit, selectedReleaseId, editState == null ? void 0 : editState.published]), getReleaseChipState = (0, import_react.useCallback)((release_0) => {
    if (!(params == null ? void 0 : params.historyVersion)) return {
      selected: getReleaseIdFromReleaseDocumentId(release_0._id) === getVersionFromId((displayed == null ? void 0 : displayed._id) || "")
    };
    const isReleaseHistoryMatch = getReleaseIdFromReleaseDocumentId(release_0._id) === params.historyVersion;
    return {
      selected: isReleaseHistoryMatch,
      disabled: isReleaseHistoryMatch
    };
  }, [displayed == null ? void 0 : displayed._id, params == null ? void 0 : params.historyVersion]), isPublishSelected = (0, import_react.useMemo)(() => {
    var _a2;
  ...
  }, [displayed == null ? void 0 : displayed._id, (_a = editState == null ? void 0 : editState.draft) == null ? void 0 : _a._id, isLiveEdit, selectedPerspectiveName, selectedReleaseId]), isDraftSelected = (0, import_react.useMemo)(() => {
  ...
  }, [displayed == null ? void 0 : displayed._id, editState == null ? void 0 : editState.published, isPublishSelected, params == null ? void 0 : params.historyVersion, selectedPerspectiveName]), isDraftDisabled = (0, import_react.useMemo)(() => (editState == null ? void 0 : editState.draft) ? false : !!(isCreatingDocument && selectedReleaseId || isLiveEdit), [editState == null ? void 0 : editState.draft, isCreatingDocument, isLiveEdit, selectedReleaseId]);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(VersionChip, { tooltipContent: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (editState == null ? void 0 : editState.published) && ((_b = editState == null ? void 0 : editState.published) == null ? void 0 : _b._updatedAt) ? (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "release.chip.tooltip.published-date", values: {
      date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.published._updatedAt))
    } }) : (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: t("release.chip.tooltip.not-published") }) }), disabled: isPublishedChipDisabled, onClick: handlePerspectiveChange("published"), selected: isPublishSelected, text: t("release.chip.published"), tone: "positive", contextValues: {
    ...
    (0, import_jsx_runtime.jsx)(VersionChip, { tooltipContent: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (editState == null ? void 0 : editState.draft) ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (editState == null ? void 0 : editState.draft._updatedAt) ? (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "release.chip.tooltip.edited-date", values: {
      date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.draft._updatedAt))
    } }) : (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "release.chip.tooltip.created-date", values: {
      date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.draft._createdAt))
    } }) }) : (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: t(isLiveEdit ? "release.chip.tooltip.draft-disabled.live-edit" : "release.chip.tooltip.no-edits") }) }), selected: isDraftSelected, disabled: isDraftDisabled, text: t("release.chip.draft"), tone: (editState == null ? void 0 : editState.draft) ? "caution" : "neutral", onClick: handlePerspectiveChange("drafts"), contextValues: {
    ...
    filteredReleases.inCreation && (0, import_jsx_runtime.jsx)(VersionChip, { tooltipContent: (0, import_jsx_runtime.jsx)(TooltipContent$1, { release: filteredReleases.inCreation }), selected: true, onClick: () => {
    }, locked: false, tone: getReleaseTone(filteredReleases.inCreation), text: filteredReleases.inCreation.metadata.title || t("release.placeholder-untitled-release"), contextValues: {
      disabled: true,
    ...
    displayed && ((_i = filteredReleases.currentReleases) == null ? void 0 : _i.map((release_1) => (0, import_jsx_runtime.jsx)(VersionChip, { tooltipContent: (0, import_jsx_runtime.jsx)(TooltipContent$1, { release: release_1 }), ...getReleaseChipState(release_1), onClick: handlePerspectiveChange(getReleaseIdFromReleaseDocumentId(release_1._id)), text: release_1.metadata.title || t("release.placeholder-untitled-release"), tone: getReleaseTone(release_1), locked: isReleaseScheduledOrScheduling(release_1), contextValues: {
      documentId: (displayed == null ? void 0 : displayed._id) || "",
...
var DocumentPanelHeader = (0, import_react.memo)((0, import_react.forwardRef)(function(_props, ref) {
  const {
    ...
    states
  }) => (0, import_jsx_runtime.jsx)(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states }), [contextMenuNodes, referenceElement]), title = (0, import_react.useMemo)(() => (0, import_jsx_runtime.jsx)(DocumentHeaderTitle, {}), []), tabs = (0, import_react.useMemo)(() => showTabs && (0, import_jsx_runtime.jsx)(DocumentHeaderTabs, {}), [showTabs]), backButton = (0, import_react.useMemo)(() => showBackButton && (0, import_jsx_runtime.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t("pane-header.back-button.text")
  } }), [BackLink2, showBackButton, t]), renderedActions = (0, import_react.useMemo)(() => (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 1, children: [
    unstable_languageFilter.length > 0 && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: unstable_languageFilter.map((LanguageFilterComponent, idx) => (0, import_jsx_runtime.jsx)(
  ...
  return (0, import_jsx_runtime.jsxs)(TooltipDelayGroupProvider, { children: [
    (0, import_jsx_runtime.jsx)(Card, { hidden: collapsed, style: {
      lineHeight: 0
    }, children: (0, import_jsx_runtime.jsxs)(Flex, { children: [
      (0, import_jsx_runtime.jsx)(Flex, { flex: 1, gap: 1, padding: 3, paddingBottom: 0, style: {
        overflowX: "scroll"
      }, children: (0, import_jsx_runtime.jsx)(DocumentPerspectiveList, {}) }),
      (0, import_jsx_runtime.jsx)(Box, { flex: "none", padding: 3, paddingBottom: 0, children: renderedActions })
    ] }) }),
    (0, import_jsx_runtime.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published), title, tabs, tabIndex, backButton })
  ] });
}));
...
var UserLine = (t0) => {
  ...
  let t1;
  $[0] !== loading || $[1] !== user ? (t1 = (0, import_jsx_runtime.jsx)(Box, { children: loading || !user ? (0, import_jsx_runtime.jsx)(AvatarSkeleton$1, { animated: true }) : (0, import_jsx_runtime.jsx)(UserAvatar, { user }) }), $[0] = loading, $[1] = user, $[2] = t1) : t1 = $[2];
  let t2;
...
function TimelineItem(t0) {
  ...
  let t10;
  $[17] !== authorUserIds ? (t10 = (0, import_jsx_runtime.jsx)(UserAvatarStack, { maxLength: 3, userIds: authorUserIds, size: 2 }), $[17] = authorUserIds, $[18] = t10) : t10 = $[18];
  const t11 = TIMELINE_ITEM_EVENT_TONE[type];
  let t12;
  $[19] !== IconComponent ? (t12 = IconComponent && (0, import_jsx_runtime.jsx)(IconComponent, {}), $[19] = IconComponent, $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== t12 ? (t13 = (0, import_jsx_runtime.jsx)(Text, { size: 0, children: t12 }), $[21] = t12, $[22] = t13) : t13 = $[22];
  let t14;
  $[23] !== t11 || $[24] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(IconBox, { align: "center", justify: "center", $color: t11, children: t13 }), $[23] = t11, $[24] = t13, $[25] = t14) : t14 = $[25];
  let t15;
  $[26] !== t10 || $[27] !== t14 ? (t15 = (0, import_jsx_runtime.jsxs)("div", { style: t9, children: [
    t10,
    t14
  ] }), $[26] = t10, $[27] = t14, $[28] = t15) : t15 = $[28];
  let t16;
  $[29] !== t || $[30] !== type ? (t16 = t(TIMELINE_ITEM_I18N_KEY_MAPPING2[type]) || (0, import_jsx_runtime.jsx)("code", { children: type }), $[29] = t, $[30] = type, $[31] = t16) : t16 = $[31];
  let t17;
  $[32] !== t16 ? (t17 = (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: t16 }), $[32] = t16, $[33] = t17) : t17 = $[33];
  let t18;
  $[34] !== formattedTimestamp || $[35] !== timestamp || $[36] !== updatedTimeAgo ? (t18 = (0, import_jsx_runtime.jsx)(Text, { as: "time", size: 1, muted: true, dateTime: timestamp, title: formattedTimestamp, children: updatedTimeAgo }), $[34] = formattedTimestamp, $[35] = timestamp, $[36] = updatedTimeAgo, $[37] = t18) : t18 = $[37];
  let t19;
  $[38] !== t17 || $[39] !== t18 ? (t19 = (0, import_jsx_runtime.jsxs)(Stack, { space: 2, children: [
    t17,
    t18
  ] }), $[38] = t17, $[39] = t18, $[40] = t19) : t19 = $[40];
  let t20;
  $[41] !== collaboratorsUsersIds ? (t20 = collaboratorsUsersIds.length > 0 && (0, import_jsx_runtime.jsx)(Flex, { flex: 1, justify: "flex-end", align: "center", children: (0, import_jsx_runtime.jsx)(Tooltip, { placement: "top", content: (0, import_jsx_runtime.jsx)(TooltipContent, { collaborators: collaboratorsUsersIds }), portal: true, children: (0, import_jsx_runtime.jsx)(Box, { paddingLeft: 2, paddingY: 2, children: (0, import_jsx_runtime.jsx)(UserAvatarStack, { maxLength: 3, userIds: collaboratorsUsersIds, size: 0, withTooltip: false }) }) }) }), $[41] = collaboratorsUsersIds, $[42] = t20) : t20 = $[42];
  let t21;
  $[43] !== t15 || $[44] !== t19 || $[45] !== t20 ? (t21 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, children: [
    t15,
    t19,
    t20
  ] }), $[43] = t15, $[44] = t19, $[45] = t20, $[46] = t21) : t21 = $[46];
  let t22;
  $[47] !== chunk.id || $[48] !== handleClick || $[49] !== isSelected || $[50] !== t21 ? (t22 = (0, import_jsx_runtime.jsx)(Card, { as: "button", onClick: handleClick, padding: 2, pressed: isSelected, radius: 2, "data-ui": "timelineItem", "data-testid": "timeline-item-button", "data-chunk-id": chunk.id, children: t21 }), $[47] = chunk.id, $[48] = handleClick, $[49] = isSelected, $[50] = t21, $[51] = t22) : t22 = $[51];
  let t23;
  return $[52] !== optionsMenu || $[53] !== t22 ? (t23 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 1, children: [
    t22,
    optionsMenu
...
function TimelineError(t0) {
  ...
  let t1;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime.jsx)(TextWithTone, { tone: "critical", children: (0, import_jsx_runtime.jsx)(ErrorOutlineIcon, {}) }), $[0] = t1) : t1 = $[0];
  let t2;
  ...
  let t3;
  $[4] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(TextWithTone, { size: 1, tone: "critical", weight: "medium", children: t2 }), $[4] = t2, $[5] = t3) : t3 = $[5];
  let t4;
  ...
  let t5;
  $[9] !== t4 ? (t5 = (0, import_jsx_runtime.jsx)(TextWithTone, { size: 1, tone: "critical", children: t4 }), $[9] = t4, $[10] = t5) : t5 = $[10];
  let t6;
  return $[11] !== t3 || $[12] !== t5 ? (t6 = (0, import_jsx_runtime.jsxs)(Flex, { align: "flex-start", gap: 3, padding: 4, children: [
    t1,
...
function TimelineMenu({
  ...
  const {
    ...
    t
  } = useTranslation2("studio"), handleOpen = (0, import_react.useCallback)(() => {
    setOpen(true);
  }, []), handleClose = (0, import_react.useCallback)(() => {
    setOpen(false);
  }, []), handleGlobalKeyDown = (0, import_react.useCallback)((event) => {
  ...
  }, [setTimelineRange, t, timelineStore, toast]), selectSince = (0, import_react.useCallback)((sinceChunk) => {
    try {
  ...
  }, [setTimelineRange, t, timelineStore, toast]), handleLoadMore = (0, import_react.useCallback)(() => {
    loading || (timelineStore == null ? void 0 : timelineStore.loadMore());
  }, [loading, timelineStore]), content = (0, import_react.useMemo)(() => {
    if (timelineError) return (0, import_jsx_runtime.jsx)(TimelineError, {});
    if (mode === "rev")
      return (0, import_jsx_runtime.jsx)(Timeline, { chunks, hasMoreChunks, lastChunk: realRevChunk, onLoadMore: handleLoadMore, onSelect: selectRev });
    const filteredChunks = realRevChunk ? chunks.filter((c2) => c2.index < realRevChunk.index) : chunks;
    return (0, import_jsx_runtime.jsx)(Timeline, { chunks: filteredChunks, hasMoreChunks, lastChunk: sinceTime, onLoadMore: handleLoadMore, onSelect: selectSince });
  }, [chunks, handleLoadMore, hasMoreChunks, mode, realRevChunk, selectRev, selectSince, sinceTime, timelineError]), formatParams2 = {
    timestamp: {
      dateStyle: "medium",
      timeStyle: "short"
    }
  }, revLabel = chunk ? t(TIMELINE_ITEM_I18N_KEY_MAPPING2[chunk.type], {
    context: "timestamp",
...
var ButtonSkeleton = () => {
  ...
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime.jsx)("div", { style: {
    margin: -5
  }, children: (0, import_jsx_runtime.jsx)(AvatarSkeleton$1, { $size: 0, animated: true }) }), $[0] = t0) : t0 = $[0];
  let t1;
  return $[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, paddingLeft: 1, paddingRight: 2, paddingY: 2, children: [
    t0,
    (0, import_jsx_runtime.jsx)(Skeleton, { animated: true, style: {
      width: "80px",
      height: "15px"
    }, radius: 2 })
  ] }), $[1] = t1) : t1 = $[1], t1;
...
var DocumentStatusButton = (t0) => {
  ...
  const t4 = (inspector == null ? void 0 : inspector.name) === HISTORY_INSPECTOR_NAME ? onHistoryClose : onHistoryOpen;
  let t5;
  $[2] !== author ? (t5 = author && (0, import_jsx_runtime.jsx)("div", { style: {
    margin: -5
  }, children: (0, import_jsx_runtime.jsx)(UserAvatar, { user: author, size: 0 }) }), $[2] = author, $[3] = t5) : t5 = $[3];
  let t6;
  $[4] !== t || $[5] !== translationKey ? (t6 = t(translationKey), $[4] = t, $[5] = translationKey, $[6] = t6) : t6 = $[6];
  let t7;
  $[7] !== relativeTime || $[8] !== t6 ? (t7 = (0, import_jsx_runtime.jsxs)(Text, { muted: true, size: 1, children: [
    t6,
    " ",
    relativeTime
  ] }), $[7] = relativeTime, $[8] = t6, $[9] = t7) : t7 = $[9];
  let t8;
  $[10] !== t5 || $[11] !== t7 ? (t8 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", flex: "none", gap: 3, children: [
    t5,
    t7
  ] }), $[10] = t5, $[11] = t7, $[12] = t8) : t8 = $[12];
  let t9;
  return $[13] !== t4 || $[14] !== t8 ? (t9 = (0, import_jsx_runtime.jsx)(MotionButton, { "data-testid": "pane-footer-document-status", animate: t2, initial: t3, mode: "bleed", onClick: t4, padding: 2, muted: true, children: t8 }), $[13] = t4, $[14] = t8, $[15] = t9) : t9 = $[15], t9;
};
var FallbackStatus = () => {
  var _a, _b, _c, _d, _e;
  const {
    ...
    selectedPerspective
  } = usePerspective(), status = (0, import_react.useMemo)(() => {
  ...
  return status ? (0, import_jsx_runtime.jsx)(DocumentStatusButton, { author: "", translationKey: status.translationKey, timestamp: status.timestamp }) : null;
};
var EventsStatus = () => {
  const $ = (0, import_react_compiler_runtime.c)(6), {
    events,
  ...
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (!event) {
    let t02;
    return $[1] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime.jsx)(FallbackStatus, {}), $[1] = t02) : t02 = $[1], t02;
  }
  const t0 = TIMELINE_ITEM_I18N_KEY_MAPPING[event.type];
  let t1;
  return $[2] !== event.author || $[3] !== event.timestamp || $[4] !== t0 ? (t1 = (0, import_jsx_runtime.jsx)(DocumentStatusButton, { author: event.author, translationKey: t0, timestamp: event.timestamp }), $[2] = event.author, $[3] = event.timestamp, $[4] = t0, $[5] = t1) : t1 = $[5], t1;
};
var TimelineStatus = () => {
  const $ = (0, import_react_compiler_runtime.c)(8), {
    timelineStore
  ...
  let t2;
  return $[4] !== author || $[5] !== event.endTimestamp || $[6] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(DocumentStatusButton, { author, translationKey: t1, timestamp: event.endTimestamp }), $[4] = author, $[5] = event.endTimestamp, $[6] = t1, $[7] = t2) : t2 = $[7], t2;
};
...
function DocumentStatusLine() {
  ...
  const $ = (0, import_react_compiler_runtime.c)(19), {
    ...
    editState,
    value
  } = useDocumentPane(), [status, setStatus] = (0, import_react.useState)(null), eventsEnabled = (_b = (_a = useSource().beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents, syncState = useSyncState(documentId, documentType, editState == null ? void 0 : editState.release), lastUpdated = value == null ? void 0 : value._updatedAt;
  let t0;
  ...
  let t1;
  $[3] !== lastUpdated || $[4] !== status || $[5] !== syncState.isSyncing ? (t1 = [status, lastUpdated, syncState.isSyncing], $[3] = lastUpdated, $[4] = status, $[5] = syncState.isSyncing, $[6] = t1) : t1 = $[6], (0, import_react.useEffect)(t0, t1);
  let t2;
  ...
  let t5;
  if ($[12] !== lastUpdated || $[13] !== syncState.isSyncing ? (t5 = [syncState.isSyncing, lastUpdated], $[12] = lastUpdated, $[13] = syncState.isSyncing, $[14] = t5) : t5 = $[14], (0, import_react.useLayoutEffect)(t4, t5), status) {
    const t62 = status || void 0;
    let t7;
    return $[15] !== t62 ? (t7 = (0, import_jsx_runtime.jsx)(DocumentStatusPulse, { status: t62 }), $[15] = t62, $[16] = t7) : t7 = $[16], t7;
  }
  if (eventsEnabled) {
    let t62;
    return $[17] === Symbol.for("react.memo_cache_sentinel") ? (t62 = (0, import_jsx_runtime.jsx)(EventsStatus, {}), $[17] = t62) : t62 = $[17], t62;
  }
  let t6;
  return $[18] === Symbol.for("react.memo_cache_sentinel") ? (t6 = (0, import_jsx_runtime.jsx)(TimelineStatus, {}), $[18] = t6) : t6 = $[18], t6;
}
...
function RevisionStatusLine() {
  ...
  const message = t1;
  let t2;
  $[5] === Symbol.for("react.memo_cache_sentinel") ? (t2 = (0, import_jsx_runtime.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(RestoreIcon, {}) }) }), $[5] = t2) : t2 = $[5];
  let t3;
  return $[6] !== message.text ? (t3 = (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsxs)(Flex, { flex: 1, gap: 3, padding: 2, children: [
    t2,
    (0, import_jsx_runtime.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime.jsx)(StatusText, { size: 1, textOverflow: "ellipsis", children: message.text }) })
...
function DocumentStatusBar(props) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(21), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = (_a = useSanityCreateConfig().components) == null ? void 0 : _a.documentLinkedActions, showingRevision = !!revisionId, [collapsed, setCollapsed] = (0, import_react.useState)(null), [rootElement, setRootElement] = (0, import_react.useState)(null);
  let t0;
  ...
  if (createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions) {
    let t32;
    $[3] !== CreateLinkedActions || $[4] !== createLinkMetadata || $[5] !== onDocumentChange || $[6] !== title ? (t32 = (0, import_jsx_runtime.jsx)(CreateLinkedActions, { metadata: createLinkMetadata, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT, onDocumentChange, documentTitle: title }), $[3] = CreateLinkedActions, $[4] = createLinkMetadata, $[5] = onDocumentChange, $[6] = title, $[7] = t32) : t32 = $[7], actions = t32;
  } else if (showingRevision) {
    let t32;
    $[8] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime.jsx)(HistoryStatusBarActions, {}), $[8] = t32) : t32 = $[8], actions = t32;
  } else {
    let t32;
    $[9] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime.jsx)(DocumentStatusBarActions, {}), $[9] = t32) : t32 = $[9], actions = t32;
  }
  const t3 = showingRevision ? "caution" : void 0;
  let t4;
  $[10] !== actions || $[11] !== actionsBoxRef || $[12] !== collapsed || $[13] !== shouldRender || $[14] !== showingRevision ? (t4 = shouldRender && (0, import_jsx_runtime.jsxs)(Flex, { align: "stretch", gap: 1, justify: "space-between", paddingY: 2, paddingLeft: showingRevision ? 3 : 4, paddingRight: showingRevision ? 2 : 3, children: [
    (0, import_jsx_runtime.jsxs)(Flex, { align: "center", flex: 1, gap: collapsed ? 2 : 3, wrap: "wrap", paddingRight: 3, children: [
      (0, import_jsx_runtime.jsxs)(Flex, { align: "center", children: [
        showingRevision ? (0, import_jsx_runtime.jsx)(RevisionStatusLine, {}) : (0, import_jsx_runtime.jsx)(DocumentStatusLine, {}),
  ...
  ] }), $[10] = actions, $[11] = actionsBoxRef, $[12] = collapsed, $[13] = shouldRender, $[14] = showingRevision, $[15] = t4) : t4 = $[15];
  let t5;
  $[16] !== t4 ? (t5 = (0, import_jsx_runtime.jsx)(Flex, { direction: "column", ref: setRootElement, sizing: "border", children: t4 }), $[16] = t4, $[17] = t5) : t5 = $[17];
  let t6;
  return $[18] !== t3 || $[19] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Card, { tone: t3, children: t5 }), $[18] = t3, $[19] = t5, $[20] = t6) : t6 = $[20], t6;
}
var KeyboardShortcutResponder = (0, import_react.memo)(function(props) {
  ...
  let t2;
  $[15] !== actionsBoxElement || $[16] !== activeAction ? (t2 = activeAction && activeAction.dialog && (0, import_jsx_runtime.jsx)(LegacyLayerProvider, { zOffset: "paneFooter", children: (0, import_jsx_runtime.jsx)(ActionStateDialog, { dialog: activeAction.dialog, referenceElement: actionsBoxElement }) }), $[15] = actionsBoxElement, $[16] = activeAction, $[17] = t2) : t2 = $[17];
  let t3;
  return $[18] !== As || $[19] !== children || $[20] !== handleKeyDown || $[21] !== id || $[22] !== rest || $[23] !== rootRef || $[24] !== t2 ? (t3 = (0, import_jsx_runtime.jsxs)(As, { id, onKeyDown: handleKeyDown, tabIndex: -1, ...rest, ref: rootRef, children: [
    children,
    t2
...
function DocumentLayout() {
  ...
  }, [onPathOpen, onFocus]), portalElements = (0, import_react.useMemo)(() => ({
  ...
  return schemaType ? (0, import_jsx_runtime.jsxs)(GetFormValueProvider, { value, children: [
    ...
    (0, import_jsx_runtime.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: (0, import_jsx_runtime.jsxs)(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
      ...
      (0, import_jsx_runtime.jsx)(PortalProvider, { __unstable_elements: portalElements, children: (0, import_jsx_runtime.jsxs)(DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.portal, children: [
        StartInCreateBanner && (0, import_jsx_runtime.jsx)(ShowWhenPaneOpen, { children: (0, import_jsx_runtime.jsx)(StartInCreateBanner, { document: value, documentId, documentType: schemaType, documentReady: ready, isInitialValueLoading: !!isInitialValueLoading, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT }) }),
        (0, import_jsx_runtime.jsx)(PaneFooter, { ref: setFooterElement, children: (0, import_jsx_runtime.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime.jsx)(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }) })
      ] }) }),
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  ...
  const {
    ...
    revisionId,
    lastNonDeletedRevId
  } = historyStore, schema = useSchema(), templates = useTemplates(), {
    setDocumentMeta
  } = useCopyPaste(), {
    __internal_tasks,
    document: {
  ...
  } = useSource(), telemetry = useTelemetry(), presenceStore = usePresenceStore(), paneRouter = usePaneRouter(), setPaneParams = paneRouter.setParams, {
    features
  } = useStructureTool(), {
    push: pushToast
  } = useToast(), {
    ...
    title = null,
    views: viewsProp = []
  } = pane2, paneOptions = useUnique(options), documentIdRaw = paneOptions.id, documentId = getPublishedId(documentIdRaw), documentType = options.type, params = useUnique(paneRouter.params) || EMPTY_PARAMS$1, perspective = usePerspective(), {
    isReleaseLocked,
    selectedReleaseId,
    selectedPerspectiveName
  } = (0, import_react.useMemo)(() => forcedVersion || {
    selectedPerspectiveName: perspective.selectedPerspectiveName,
    selectedReleaseId: perspective.selectedReleaseId,
    isReleaseLocked: isReleaseDocument(perspective.selectedPerspective) ? isReleaseScheduledOrScheduling(perspective.selectedPerspective) : false
  ...
  }), initialValue = useUnique(initialValueRaw), isInitialValueLoading = initialValue.loading, {
    patch
  } = useDocumentOperation(documentId, documentType, selectedReleaseId), schemaType = schema.get(documentType), editState = useEditState(documentId, documentType, "default", selectedReleaseId), {
    validation: validationRaw
  } = useValidationStatus(documentId, documentType, selectedReleaseId), connectionState = useConnectionState(documentId, documentType, selectedReleaseId), liveEdit = !!(schemaType == null ? void 0 : schemaType.liveEdit), value = (0, import_react.useMemo)(() => selectedReleaseId ? editState.version || editState.draft || editState.published || initialValue.value : selectedPerspectiveName && isPublishedPerspective(selectedPerspectiveName) ? editState.published || (liveEdit ? initialValue.value : {
    _id: documentId,
    _type: documentType
  }) : editState.draft || editState.published || initialValue.value, [documentId, documentType, editState.draft, editState.published, editState.version, initialValue.value, liveEdit, selectedPerspectiveName, selectedReleaseId]), [isDeleting, setIsDeleting] = (0, import_react.useState)(false), getDocumentVersionType = (0, import_react.useCallback)(() => {
    let version;
    switch (true) {
      case !!params.rev:
        version = "revision";
    ...
    return version;
  }, [selectedPerspectiveName, selectedReleaseId, params, value._id]), actionsPerspective = (0, import_react.useMemo)(() => getDocumentVersionType(), [getDocumentVersionType]), documentActionsProps = (0, import_react.useMemo)(() => ({
  ...
  }), [documentType, documentId, actionsPerspective, selectedReleaseId]), actions = (0, import_react.useMemo)(() => documentActions2(documentActionsProps), [documentActions2, documentActionsProps]), badges = (0, import_react.useMemo)(() => documentBadges2({
    schemaType: documentType,
    documentId
  }), [documentBadges2, documentId, documentType]), languageFilter = (0, import_react.useMemo)(() => languageFilterResolver({
    schemaType: documentType,
    documentId
  }), [documentId, documentType, languageFilterResolver]), validation = useUnique(validationRaw), views2 = useUnique(viewsProp), [focusPath, setFocusPath] = (0, import_react.useState)(() => params.path ? fromString(params.path) : EMPTY_ARRAY$C), focusPathRef = (0, import_react.useRef)([]), activeViewId = params.view || views2[0] && views2[0].id || null, isDeleted = (0, import_react.useMemo)(() => timelineReady ? !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) && !(editState == null ? void 0 : editState.version) && !isPristine : false, [editState == null ? void 0 : editState.draft, editState == null ? void 0 : editState.published, editState == null ? void 0 : editState.version, isPristine, timelineReady]), previewUrl = usePreviewUrl(value), [presence, setPresence] = (0, import_react.useState)([]);
  (0, import_react.useEffect)(() => {
  ...
  const currentInspector = inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), changesOpen = (currentInspector == null ? void 0 : currentInspector.name) === HISTORY_INSPECTOR_NAME, {
    t
  } = useTranslation2(structureLocaleNamespace), inspectOpen = params.inspect === "on", compareValue = changesOpen ? sinceDocument : (editState == null ? void 0 : editState.published) || null, fieldActions = (0, import_react.useMemo)(() => schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  }) : [], [documentId, documentType, fieldActionsResolver, schemaType]), ready = connectionState === "connected" && editState.ready && (!params.rev || timelineReady || !!timelineError), displayed = (0, import_react.useMemo)(() => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
  } : value, [onOlderRevision, revisionDocument, value]), setTimelineRange = (0, import_react.useCallback)((newSince, newRev) => {
    setPaneParams({
      ...params,
      since: newSince,
      rev: newRev || void 0
    ...
    disableBlurRef.current || (setFocusPath(EMPTY_ARRAY$C), focusPathRef.current !== EMPTY_ARRAY$C && (focusPathRef.current = EMPTY_ARRAY$C, onFocusPath == null ? void 0 : onFocusPath(EMPTY_ARRAY$C)));
  }, [onFocusPath, setFocusPath]), closeInspector = (0, import_react.useCallback)((closeInspectorName) => {
    var _a2, _b2;
    ...
    if (currentInspector) {
      ...
      if (currentInspector) {
        const result_0 = ((_b2 = currentInspector.onClose) == null ? void 0 : _b2.call(currentInspector, {
          params
        })) ?? {
          params
        };
    ...
    const result_1 = ((_b2 = nextInspector.onOpen) == null ? void 0 : _b2.call(nextInspector, {
      params: currentParams
    })) ?? {
      params: currentParams
    };
  ...
  }, [inspectOpen, params, setPaneParams]), handleMenuAction = (0, import_react.useCallback)((item) => {
  ...
  }, []), handleSetActiveFieldGroup = (0, import_react.useCallback)((path_1, groupName) => onSetFieldGroupState((prevState_1) => setAtPath(prevState_1, path_1, groupName)), []), requiredPermission = value._createdAt ? "update" : "create", docId = value._id ? value._id : "dummy-id", docPermissionsInput = (0, import_react.useMemo)(() => ({
    ...value,
    _id: liveEdit ? getPublishedId(docId) : getDraftId(docId)
  }), [liveEdit, value, docId]), [permissions, isPermissionsLoading] = useDocumentValuePermissions({
    document: docPermissionsInput,
    permission: requiredPermission
  }), isCreateLinked = isSanityCreateLinkedDocument(value), isNonExistent = !(value == null ? void 0 : value._id), willBeUnpublished = isGoingToUnpublish(value), readOnly = (0, import_react.useMemo)(() => {
    var _a2, _b2;
    const hasNoPermission = !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted), updateActionDisabled = !isActionEnabled(schemaType, "update"), createActionDisabled = isNonExistent && !isActionEnabled(schemaType, "create"), reconnecting = connectionState === "reconnecting", isLocked = (_a2 = editState.transactionSyncLock) == null ? void 0 : _a2.enabled;
    return liveEdit && ((_b2 = editState.draft) == null ? void 0 : _b2._id) || !liveEdit && selectedPerspectiveName === "published" || selectedReleaseId && getVersionFromId(value._id) !== selectedReleaseId ? true : willBeUnpublished || !ready || revisionId !== null || hasNoPermission || updateActionDisabled || createActionDisabled || reconnecting || isLocked || isDeleting || isDeleted || isCreateLinked || isReleaseLocked;
  }, [isPermissionsLoading, permissions == null ? void 0 : permissions.granted, schemaType, isNonExistent, connectionState, (_a = editState.transactionSyncLock) == null ? void 0 : _a.enabled, (_b = editState.draft) == null ? void 0 : _b._id, liveEdit, selectedPerspectiveName, selectedReleaseId, value._id, willBeUnpublished, ready, revisionId, isDeleting, isDeleted, isCreateLinked, isReleaseLocked]), patchRef = (0, import_react.useRef)(() => {
  ...
  }), handleChange = (0, import_react.useCallback)((event) => patchRef.current(event), []);
  (0, import_react.useInsertionEffect)(() => {
    readOnly && !isCreateLinked ? patchRef.current = () => {
  ...
  }, [editState.draft, editState.published, initialValue.value, patch, telemetry, readOnly, isCreateLinked]);
  ...
  const setOpenPath = (0, import_react.useCallback)((path_2) => {
  ...
  }, [presenceStore, value._id]), updatePresenceThrottled = (0, import_react.useMemo)(() => (0, import_throttle.default)(updatePresence, 1e3, {
    leading: true,
    trailing: true
    ...
    revisionId,
    lastNonDeletedRevId
  }), [actions, activeViewId, badges, changesOpen, closeInspector, collapsedFieldSets, collapsedPaths, compareValue, connectionState, displayed, documentId, documentIdRaw, documentType, editState, fieldActions, focusPath, currentInspector, inspectors2, __internal_tasks, handleBlur, handleChange, handleFocus, setOpenPath, handleHistoryClose, handleHistoryOpen, handleLegacyInspectClose, handleMenuAction, handlePaneClose, handlePaneSplit, handleSetActiveFieldGroup, handleOnSetCollapsedPath, handleOnSetCollapsedFieldSet, openInspector, openPath, index, inspectOpen, validation, menuItemGroups, paneKey, previewUrl, ready, schemaType, isPermissionsLoading, isInitialValueLoading, permissions, setTimelineRange, isDeleting, isDeleted, timelineError, timelineStore, title, value, selectedReleaseId, views2, formState, languageFilter, revisionId, lastNonDeletedRevId]);
  (0, import_react.useEffect)(() => {
    let timeout;
...
var DocumentEventsPane = (props) => {
  ...
  const $ = (0, import_react_compiler_runtime.c)(37), {
    params: t0
  } = usePaneRouter(), params = t0 === void 0 ? EMPTY_PARAMS$1 : t0, options = usePaneOptions(props.pane.options, params), schema = useSchema(), documentType = options.type, liveEdit = !!((_a = schema.get(options.type)) == null ? void 0 : _a.liveEdit), {
    selectedPerspectiveName,
    selectedReleaseId,
    selectedPerspective
  } = usePerspective(), {
  ...
  const value = t14;
  let t15;
  $[30] !== historyStoreProps || $[31] !== historyVersion || $[32] !== props ? (t15 = historyVersion ? (0, import_jsx_runtime.jsx)(PerspectiveProvider, { selectedPerspectiveName: historyVersion, excludedPerspectives: EMPTY_ARRAY$C, children: (0, import_jsx_runtime.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }) }) : (0, import_jsx_runtime.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }), $[30] = historyStoreProps, $[31] = historyVersion, $[32] = props, $[33] = t15) : t15 = $[33];
  let t16;
  return $[34] !== t15 || $[35] !== value ? (t16 = (0, import_jsx_runtime.jsx)(EventsProvider, { value, children: t15 }), $[34] = t15, $[35] = value, $[36] = t16) : t16 = $[36], t16;
};
function _temp$5(e) {
...
var DocumentPaneWithLegacyTimelineStore = (props) => {
  const $ = (0, import_react_compiler_runtime.c)(20), {
    pane: pane2
  } = props, paneRouter = usePaneRouter(), options = usePaneOptions(pane2.options, paneRouter.params), params = paneRouter.params || EMPTY_PARAMS$1, [timelineError, setTimelineError] = (0, import_react.useState)(null);
  let t0;
  ...
  let t8;
  return $[17] !== historyStoreProps || $[18] !== props ? (t8 = (0, import_jsx_runtime.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }), $[17] = historyStoreProps, $[18] = props, $[19] = t8) : t8 = $[19], t8;
};
...
var DocumentPaneProviderWrapper = (0, import_react.memo)((props) => {
  ...
  if ((_b = (_a = useSource().beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents) {
    let t02;
    return $[0] !== props ? (t02 = (0, import_jsx_runtime.jsx)(DocumentEventsPane, { ...props }), $[0] = props, $[1] = t02) : t02 = $[1], t02;
  }
  let t0;
  return $[2] !== props ? (t0 = (0, import_jsx_runtime.jsx)(DocumentPaneWithLegacyTimelineStore, { ...props }), $[2] = props, $[3] = t0) : t0 = $[3], t0;
});
...
function useResetHistoryParams() {
  const $ = (0, import_react_compiler_runtime.c)(10), {
    params: t0,
    setParams
  } = usePaneRouter(), params = t0 === void 0 ? EMPTY_PARAMS$1 : t0, {
    selectedPerspectiveName
  } = usePerspective(), isMounted = (0, import_react.useRef)(false);
  let t1;
...
function DocumentPaneInner(props) {
  ...
  let t12;
  return $[49] !== providerProps || $[50] !== t11 || $[51] !== t8 ? (t12 = (0, import_jsx_runtime.jsx)(DocumentPaneProviderWrapper, { ...providerProps, children: t11 }, t8), $[49] = providerProps, $[50] = t11, $[51] = t8, $[52] = t12) : t12 = $[52], t12;
}
function _temp$3(t0) {
  const {
    children
...
function DocumentListPaneContent(props) {
  ...
  bb1: {
    ...
    if (error) {
      ...
      let t73;
      $[29] !== t63 ? (t73 = (0, import_jsx_runtime.jsx)(Heading, { as: "h3", children: t63 }), $[29] = t63, $[30] = t73) : t73 = $[30];
      let t82;
      ...
      let t10;
      $[34] !== t || $[35] !== t82 ? (t10 = (0, import_jsx_runtime.jsx)(Text, { as: "p", children: (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "panes.document-list-pane.error.text", values: t82, components: t9 }) }), $[34] = t, $[35] = t82, $[36] = t10) : t10 = $[36];
      let t11;
      $[37] !== error || $[38] !== onRetry ? (t11 = (0, import_jsx_runtime.jsx)(ErrorActions, { error, eventId: null, onRetry }), $[37] = error, $[38] = onRetry, $[39] = t11) : t11 = $[39];
      let t12;
      $[40] !== t10 || $[41] !== t11 || $[42] !== t73 ? (t12 = (0, import_jsx_runtime.jsx)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: (0, import_jsx_runtime.jsx)(Container, { width: 1, children: (0, import_jsx_runtime.jsxs)(Stack, { paddingX: 4, paddingY: 5, space: 4, children: [
        t73,
        t10,
        t11
    ...
    if (loadingVariant === "initial" && isLoading) {
      let t63;
      $[44] !== layout ? (t63 = (0, import_jsx_runtime.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime.jsx)(LoadingView, { layout }) }), $[44] = layout, $[45] = t63) : t63 = $[45], t5 = t63;
      break bb1;
    }
...
function removePublishedWithDrafts(documents) {
  return collate(documents).map((entry) => {
    const doc = entry.draft || entry.published, isVersion = (doc == null ? void 0 : doc.id) && isVersionId(doc._id), hasDraft = !!entry.draft;
    return {
      ...doc,
...
function useDocumentList(opts) {
  const {
    ...
    strategy: searchStrategy
  } = useWorkspace().search, schema = useSchema(), maxFieldDepth = useSearchMaxFieldDepth(), typeNameFromFilter = (0, import_react.useMemo)(() => findStaticTypesInFilter(searchFilter, paramsProp), [searchFilter, paramsProp]), [[onRetry$, onRetry]] = (0, import_react.useState)(() => observableCallback()), [[onFetchFullList$, onLoadFullList]] = (0, import_react.useState)(() => observableCallback()), queryResults$ = (0, import_react.useMemo)(() => {
...
var DocumentListPane = (0, import_react.memo)(function(props) {
  const {
    ...
    sortOrder
  }), isLoading = documentListIsLoading || releases.loading, handleQueryChange = useObservableEvent((event$) => event$.pipe(map((event) => event.target.value), tap(setSearchInputValue), debounce((value) => value === "" ? of("") : timer(300)), tap(setSearchQuery))), handleClearSearch = (0, import_react.useCallback)(() => {
...
var PreviewCell = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, children: [
    (0, import_jsx_runtime.jsx)(DocumentStatusIndicator, { draft, published, versions: void 0 }),
...
function DocumentSheetListHeader(props) {
  ...
  return (0, import_jsx_runtime.jsx)(HeaderTag, { style: {
    ...
    }, menu: (0, import_jsx_runtime.jsx)(Menu, { children: (0, import_jsx_runtime.jsx)(MenuItem2, { text: t("sheet-list.hide-field"), icon: CloseIcon, onClick: () => header.column.toggleVisibility() }) }) }) })
  ] }) }, header.id);
}
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    return ((_a = item.params) == null ? void 0 : _a.layout) ? {
      ...
      ...item,
      selected: (0, import_isEqual.default)(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$C)
    } : {
      ...item,
      selected: false
    };
...
var PaneContainer = (0, import_react.memo)(function(props) {
  const $ = (0, import_react_compiler_runtime.c)(36), {
    ...
    menuItems,
    options
  } = pane2, defaultLayout = t0 === void 0 ? "default" : t0, initialValueTemplates = t1 === void 0 ? EMPTY_ARRAY$C : t1, {
    defaultOrdering: t2,
    filter: filter2
  } = options, defaultOrdering = t2 === void 0 ? EMPTY_ARRAY$C : t2, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane2.source;
  let t3;
  bb0: {
    let t42;
...
function getPaneParams(intent, {
  ...
  return intent !== "create" ? EMPTY_PARAMS$2 : template && version ? {
    template,
    version
  } : template ? {
    template
...
function ChangesInspector(t0) {
  ...
  if (selectedReleaseId) {
    let t32;
    return $[6] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: (0, import_jsx_runtime.jsx)(TimelineError, { versionError: true }) }) }), $[6] = t32) : t32 = $[6], t32;
  }
  let t3;
  $[7] !== structureT ? (t3 = structureT("changes.from.label"), $[7] = structureT, $[8] = t3) : t3 = $[8];
  let t4;
  $[9] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Text, { size: 1, muted: true, children: t3 }), $[9] = t3, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== sinceTime ? (t5 = (0, import_jsx_runtime.jsx)(TimelineMenu, { mode: "since", chunk: sinceTime, placement: "bottom-start" }), $[11] = sinceTime, $[12] = t5) : t5 = $[12];
  let t6;
  $[13] !== structureT ? (t6 = structureT("changes.to.label"), $[13] = structureT, $[14] = t6) : t6 = $[14];
  let t7;
  $[15] !== t6 ? (t7 = (0, import_jsx_runtime.jsx)(Text, { size: 1, muted: true, children: t6 }), $[15] = t6, $[16] = t7) : t7 = $[16];
  let t8;
  $[17] !== rev ? (t8 = (0, import_jsx_runtime.jsx)(TimelineMenu, { chunk: rev, mode: "rev", placement: "bottom-end" }), $[17] = rev, $[18] = t8) : t8 = $[18];
  let t9;
  $[19] !== t4 || $[20] !== t5 || $[21] !== t7 || $[22] !== t8 ? (t9 = (0, import_jsx_runtime.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime.jsxs)(Grid$1, { paddingX: 2, paddingBottom: 2, children: [
    t4,
    t5,
    t7,
    t8
  ...
  let t10;
  $[24] !== diff || $[25] !== documentContext || $[26] !== loading || $[27] !== schemaType || $[28] !== showChanges || $[29] !== timelineError ? (t10 = showChanges && (0, import_jsx_runtime.jsx)(Content$1, { diff, documentContext, error: timelineError, loading, schemaType }), $[24] = diff, $[25] = documentContext, $[26] = loading, $[27] = schemaType, $[28] = showChanges, $[29] = timelineError, $[30] = t10) : t10 = $[30];
  let t11;
  $[31] !== t10 ? (t11 = (0, import_jsx_runtime.jsx)(Scroller$3, { "data-ui": "Scroller", ref: setScrollRef, children: (0, import_jsx_runtime.jsx)(Box, { flex: 1, paddingX: 3, height: "fill", children: t10 }) }), $[31] = t10, $[32] = t11) : t11 = $[32];
  let t12;
  $[33] !== scrollRef || $[34] !== t11 ? (t12 = (0, import_jsx_runtime.jsx)(Card, { flex: 1, paddingX: 2, paddingY: 2, children: (0, import_jsx_runtime.jsx)(BoundaryElementProvider, { element: scrollRef, children: t11 }) }), $[33] = scrollRef, $[34] = t11, $[35] = t12) : t12 = $[35];
  let t13;
  return $[36] !== t12 || $[37] !== t9 ? (t13 = (0, import_jsx_runtime.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    t9,
    t12
...
function EventTimelineItem(t0) {
  ...
  let t7;
  $[11] !== event ? (t7 = (0, import_jsx_runtime.jsx)(Event$1, { event, showChangesBy: "tooltip" }), $[11] = event, $[12] = t7) : t7 = $[12];
  let t8;
  $[13] !== event.timestamp || $[14] !== handleClick || $[15] !== isSelected || $[16] !== t4 || $[17] !== t6 || $[18] !== t7 ? (t8 = (0, import_jsx_runtime.jsx)(Card, { as: t4, onClick: handleClick, padding: 2, pressed: isSelected, radius: 2, "data-ui": "timelineItem", "data-testid": "timeline-item-button", "data-chunk-timestamp": event.timestamp, style: t6, children: t7 }), $[13] = event.timestamp, $[14] = handleClick, $[15] = isSelected, $[16] = t4, $[17] = t6, $[18] = t7, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== optionsMenu || $[21] !== t8 ? (t9 = (0, import_jsx_runtime.jsxs)(Flex, { gap: 1, children: [
    t8,
    optionsMenu
  ] }), $[20] = optionsMenu, $[21] = t8, $[22] = t9) : t9 = $[22];
  let t10;
  return $[23] !== isSelectable || $[24] !== t3 || $[25] !== t9 ? (t10 = (0, import_jsx_runtime.jsx)(Tooltip, { content: t3, disabled: isSelectable, children: t9 }), $[23] = isSelectable, $[24] = t3, $[25] = t9, $[26] = t10) : t10 = $[26], t10;
}
function PublishedEventMenu(t0) {
  ...
  $[11] !== event.release ? (t3 = (t42) => {
    ...
    return (0, import_jsx_runtime.jsx)(VersionInlineBadge, { $tone: event.release ? getReleaseTone(event.release) : void 0, children });
  ...
  let t8;
  $[19] !== t5 || $[20] !== t7 ? (t8 = (0, import_jsx_runtime.jsx)(ContextMenuButton, { "aria-label": t5, tooltipProps: t7 }), $[19] = t5, $[20] = t7, $[21] = t8) : t8 = $[21];
  let t9;
  $[22] !== VersionBadge || $[23] !== event.release || $[24] !== event.versionRevisionId || $[25] !== handleOpenDraftDocument || $[26] !== handleOpenReleaseDocument || $[27] !== t ? (t9 = (0, import_jsx_runtime.jsx)(Menu, { padding: 1, children: event.release ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(IntentLink, { intent: RELEASES_INTENT, params: {
      id: (_a = event.release) == null ? void 0 : _a.name
    }, style: {
      textDecoration: "none"
    }, children: (0, import_jsx_runtime.jsx)(MenuItem, { padding: 3, children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", children: (0, import_jsx_runtime.jsx)(Text, { size: 1, style: {
      textDecoration: "none"
    }, children: (0, import_jsx_runtime.jsx)(Translate, { components: {
      VersionBadge: (t102) => {
        const {
          children: children_0
        } = t102;
        return (0, import_jsx_runtime.jsxs)(VersionBadge, { children: [
          children_0,
          " "
        ] });
      }
    ...
    (0, import_jsx_runtime.jsx)(MenuItem, { onClick: handleOpenReleaseDocument, children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Translate, { components: {
      VersionBadge: (t112) => {
        const {
          children: children_1
        } = t112;
  ...
  ] }) : (0, import_jsx_runtime.jsx)(MenuItem, { onClick: handleOpenDraftDocument, disabled: !event.versionRevisionId, children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Translate, { components: {
    VersionBadge: _temp
  ...
  const t10 = ((_b = portalContext.elements) == null ? void 0 : _b[TIMELINE_MENU_PORTAL$1]) ? TIMELINE_MENU_PORTAL$1 : true;
  let t11;
  ...
  let t13;
  return $[32] !== t12 || $[33] !== t4 || $[34] !== t8 || $[35] !== t9 ? (t13 = (0, import_jsx_runtime.jsx)(MenuButton, { id: t4, button: t8, menu: t9, popover: t12 }), $[32] = t12, $[33] = t4, $[34] = t8, $[35] = t9, $[36] = t13) : t13 = $[36], t13;
}
function _temp(t0) {
  const {
    children: children_2
  } = t0;
  return (0, import_jsx_runtime.jsx)(VersionInlineBadge, { $tone: "caution", children: children_2 });
}
...
var EventsTimeline = ({
  ...
  const [mounted, setMounted] = (0, import_react.useState)(false), {
    t
  } = useTranslation2("studio"), [expandedParents, setExpandedParents] = (0, import_react.useState)(() => {
    if (selectedEventId) {
    ...
    return /* @__PURE__ */ new Set();
  }), [expandingParents, setExpandingParents] = (0, import_react.useState)(/* @__PURE__ */ new Set()), events = (0, import_react.useMemo)(() => allEvents.filter((event_0) => isCreateDocumentVersionEvent(event_0) && event_0.parentId ? allEvents[allEvents.length - 1].id === event_0.id ? true : expandedParents.has(event_0.parentId) : isEditDocumentVersionEvent(event_0) && event_0.parentId ? expandedParents.has(event_0.parentId) : true), [expandedParents, allEvents]), handleExpandParent = (0, import_react.useCallback)((event_1) => async () => {
  ...
  }, [fetchEventChildren, setExpandingParents]), handleSelectChunk = (0, import_react.useCallback)((event_2) => {
    onSelect(event_2);
  }, [onSelect]), renderOptionsMenu = (0, import_react.useCallback)((event_3) => {
    const documentVariantType = getDocumentVariantType(event_3.documentId);
    return isPublishDocumentVersionEvent(event_3) && documentVariantType === "published" ? (0, import_jsx_runtime.jsx)(PublishedEventMenu, { event: event_3 }) : isPublishDocumentVersionEvent(event_3) && documentVariantType === "draft" && event_3.creationEvent ? (0, import_jsx_runtime.jsx)(ExpandableTimelineItemButton, { isExpanded: expandedParents.has(event_3.id), onExpand: handleExpandParent(event_3) }) : null;
  }, [expandedParents, handleExpandParent]), renderItem = (0, import_react.useCallback)((event_4, {
    activeIndex
  }) => {
    ...
    return showExpandingLoader ? (0, import_jsx_runtime.jsx)(TimelineItemWrapper, { animate: {
      opacity: 1
    }, initial: {
      opacity: 0
    }, transition: {
      duration: 0.2,
      delay: 0.2
    }, children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "center", style: {
      height: ITEM_HEIGHT
      ...
      (0, import_jsx_runtime.jsx)(EventTimelineItem, { event: event_4, isSelected: event_4.id === selectedEventId, onSelect: handleSelectChunk, optionsMenu: renderOptionsMenu(event_4) }),
      isLastEvent_0 && hasMoreEvents && (0, import_jsx_runtime.jsx)(LoadingBlock, {})
    ] }, event_4.timestamp);
...
function EventsTimelineMenu({
  ...
  const {
    setTimelineRange
  } = useDocumentPane(), [open, setOpen] = (0, import_react.useState)(false), [button, setButton] = (0, import_react.useState)(null), [popoverRef, setPopoverRef] = (0, import_react.useState)(null), toast = useToast(), {
    nextCursor,
    loading,
    error: eventsError,
    ...
    setOpen(false);
  }, []), handleGlobalKeyDown = (0, import_react.useCallback)((e) => {
    open && (e.key === "Escape" || e.key === "Tab") && (handleClose(), button == null ? void 0 : button.focus());
  }, [button, handleClose, open]);
  useGlobalKeyDown(handleGlobalKeyDown), useClickOutsideEvent(open && handleClose, () => [button, popoverRef]);
  const selectRev = (0, import_react.useCallback)((revEvent) => {
    try {
  ...
  }, [t, toast, setTimelineRange, findRangeForRevision, handleClose]), selectSince = (0, import_react.useCallback)((sinceEvent) => {
    try {
  ...
  }, [findRangeForSince, setTimelineRange, toast, t, handleClose]), handleLoadMore = (0, import_react.useCallback)(() => {
    !loading && nextCursor && loadMoreEvents();
  }, [loading, loadMoreEvents, nextCursor]), content = (0, import_react.useMemo)(() => eventsError ? (0, import_jsx_runtime.jsx)(TimelineError, {}) : (0, import_jsx_runtime.jsx)(EventsTimeline, { events, fetchEventChildren: expandEvent, hasMoreEvents: !!nextCursor, selectedEventId: event == null ? void 0 : event.id, onLoadMore: handleLoadMore, onSelect: mode === "rev" ? selectRev : selectSince }), [eventsError, mode, expandEvent, events, nextCursor, event == null ? void 0 : event.id, handleLoadMore, selectSince, selectRev]), revLabel = event ? t(TIMELINE_ITEM_I18N_KEY_MAPPING[event.type], {
    context: "timestamp",
    timestamp: new Date(event.timestamp),
    formatParams
  }) : t("timeline.latest-revision"), sinceLabel = event ? t(TIMELINE_ITEM_I18N_KEY_MAPPING[event.type], {
    context: "timestamp",
    timestamp: new Date(event.timestamp),
    formatParams
  ...
  }, children: (0, import_jsx_runtime.jsx)(Root, { "data-testid": "timeline-menu", constrainSize: true, content: open && content, "data-ui": "versionMenu", open, placement, matchReferenceWidth: true, portal: true, ref: setPopoverRef, children: (0, import_jsx_runtime.jsx)(Flex, { width: "fill", children: (0, import_jsx_runtime.jsx)(Button2, { "data-testid": open ? "timeline-menu-close-button" : "timeline-menu-open-button", disabled: loading || !events.length, mode: "ghost", onClick: open ? handleClose : handleOpen, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: {
    maxWidth: "100%"
...
function EventsInspector({
  ...
  const {
    ...
    value,
    formState
  } = useDocumentPane(), [scrollRef, setScrollRef] = (0, import_react.useState)(null), {
    events,
    revision,
    sinceRevision,
    getChangesList
  } = useEvents(), isComparingCurrent = !(revision == null ? void 0 : revision.revisionId), changesList$ = (0, import_react.useMemo)(() => getChangesList(), [getChangesList]), {
    diff,
    loading: diffLoading
  } = useObservable(changesList$, DIFF_INITIAL_VALUE), {
    t
  } = useTranslation2("studio"), documentContext = (0, import_react.useMemo)(() => ({
    documentId,
    schemaType,
    FieldWrapper: ChangeFieldWrapper,
    rootDiff: diff,
    ...
    value,
    showFromValue: true
  }), [diff, documentId, isComparingCurrent, formState == null ? void 0 : formState.readOnly, schemaType, value]), [sinceEvent, toEvent] = (0, import_react.useMemo)(() => events ? [events.find((e) => e.id === (sinceRevision == null ? void 0 : sinceRevision.revisionId)) || null, events.find((e_0) => e_0.id === (revision == null ? void 0 : revision.revisionId)) || events[0]] : [null, null], [events, revision == null ? void 0 : revision.revisionId, sinceRevision == null ? void 0 : sinceRevision.revisionId]), sinceEvents = (0, import_react.useMemo)(() => toEvent ? events.slice(events.indexOf(toEvent) + 1).map((event) => "parentId" in toEvent && "parentId" in event && event.parentId === toEvent.parentId ? {
    ...event,
    parentId: void 0
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    (0, import_jsx_runtime.jsxs)(Box, { padding: 3, style: {
      position: "relative"
    }, children: [
      (0, import_jsx_runtime.jsxs)(Grid2, { paddingX: 2, paddingBottom: 2, children: [
        (0, import_jsx_runtime.jsx)(Text, { size: 1, muted: true, children: t("changes.inspector.from-label") }),
        (0, import_jsx_runtime.jsx)(EventsTimelineMenu, { event: sinceEvent || null, events: sinceEvents, mode: "since", placement: "bottom-start" }),
        (0, import_jsx_runtime.jsx)(Text, { size: 1, muted: true, children: t("changes.inspector.to-label") }),
        (0, import_jsx_runtime.jsx)(EventsTimelineMenu, { event: toEvent || null, events, mode: "rev", placement: "bottom-end" })
      ] }),
      diffLoading && (0, import_jsx_runtime.jsx)(motion.div, { animate: {
        opacity: 1
      }, initial: {
        opacity: 0
      }, transition: {
        delay: 0.2,
        duration: 0.2
      }, children: (0, import_jsx_runtime.jsxs)(SpinnerContainer, { justify: "center", align: "center", gap: 2, children: [
        (0, import_jsx_runtime.jsx)(Text, { muted: true, size: 0, children: t("changes.loading-changes") }),
        (0, import_jsx_runtime.jsx)(Spinner, { size: 0 })
      ] }) })
    ] }),
    (0, import_jsx_runtime.jsx)(Card, { flex: 1, paddingX: 2, paddingY: 2, children: (0, import_jsx_runtime.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime.jsx)(Scroller$2, { "data-ui": "Scroller", ref: setScrollRef, children: (0, import_jsx_runtime.jsx)(Box, { flex: 1, paddingX: 3, height: "fill", children: showChanges && (0, import_jsx_runtime.jsx)(Content, { documentContext, error: timelineError, loading: (revision == null ? void 0 : revision.loading) || (sinceRevision == null ? void 0 : sinceRevision.loading) || false, schemaType }) }) }) }) })
  ] });
}
function Content(t0) {
  const $ = (0, import_react_compiler_runtime.c)(9), {
  ...
  if (error) {
    let t12;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime.jsx)(ChangesError, {}), $[0] = t12) : t12 = $[0], t12;
  }
  if (loading) {
    let t12;
    return $[1] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime.jsx)(LoadingBlock, { showText: true }), $[1] = t12) : t12 = $[1], t12;
  ...
  if (!documentContext.rootDiff) {
    let t12;
    return $[2] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime.jsx)(motion.div, { animate: {
      opacity: 1
    }, initial: {
      opacity: 0
    }, transition: {
      delay: 0.2,
      duration: 0.2
    }, children: (0, import_jsx_runtime.jsx)(NoChanges, {}) }), $[2] = t12) : t12 = $[2], t12;
  }
  let t1;
  $[3] !== documentContext.rootDiff || $[4] !== schemaType ? (t1 = (0, import_jsx_runtime.jsx)(ChangeList, { diff: documentContext.rootDiff, schemaType }), $[3] = documentContext.rootDiff, $[4] = schemaType, $[5] = t1) : t1 = $[5];
  let t2;
  return $[6] !== documentContext || $[7] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(DocumentChangeContext.Provider, { value: documentContext, children: t1 }), $[6] = documentContext, $[7] = t1, $[8] = t2) : t2 = $[8], t2;
}
...
function EventsSelector({
  ...
  var _a;
  const [scrollRef, setScrollRef] = (0, import_react.useState)(null), [listHeight, setListHeight] = (0, import_react.useState)(0), {
    setTimelineRange
  } = useDocumentPane(), getScrollerRef = (0, import_react.useCallback)((el) => {
    ...
    t
  } = useTranslation2("studio"), toast = useToast(), selectRev = (0, import_react.useCallback)((event) => {
    try {
  ...
  return (0, import_jsx_runtime.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: error ? (0, import_jsx_runtime.jsx)(TimelineError, {}) : (0, import_jsx_runtime.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime.jsxs)(Scroller$1, { "data-ui": "Scroller", ref: getScrollerRef, children: [
    ...
    loading && (0, import_jsx_runtime.jsx)(LoadingBlock, {})
  ] }) }) }) });
}
...
function HistorySelector({
  ...
  const {
    ...
    selectedReleaseId
  } = usePerspective(), [scrollRef, setScrollRef] = (0, import_react.useState)(null), [listHeight, setListHeight] = (0, import_react.useState)(0), getScrollerRef = (0, import_react.useCallback)((el) => {
    ...
    t
  } = useTranslation2("studio"), toast = useToast(), selectRev = (0, import_react.useCallback)((revChunk) => {
    try {
      const [sinceId, revId] = (timelineStore == null ? void 0 : timelineStore.findRangeForRev(revChunk)) || [null, null];
      setTimelineRange(sinceId, revId);
    } catch (err) {
  ...
  return (0, import_jsx_runtime.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: timelineError || selectedReleaseId ? (0, import_jsx_runtime.jsx)(TimelineError, { versionError: !!selectedReleaseId }) : (0, import_jsx_runtime.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime.jsx)(Scroller, { "data-ui": "Scroller", ref: getScrollerRef, children: listHeight && // This forces the list to unmount and remount, which is needed to reset the scroll position
  showList ? (0, import_jsx_runtime.jsx)(Timeline, { chunks, hasMoreChunks, lastChunk: realRevChunk, onLoadMore: handleLoadMore, onSelect: selectRev, listMaxHeight: `${listHeight}px` }) : null }) }) }) });
}
...
function ChangesTabs(props) {
  ...
  let t6;
  $[9] !== t3 || $[10] !== t4 || $[11] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Tab, { "aria-controls": "history-panel", id: "history-tab", label: t3, onClick: t4, selected: t5 }), $[9] = t3, $[10] = t4, $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  ...
  let t10;
  $[17] !== t7 || $[18] !== t8 || $[19] !== t9 ? (t10 = (0, import_jsx_runtime.jsx)(Tab, { "aria-controls": "review-changes-panel", id: "changes-tab", label: t7, onClick: t8, selected: t9 }), $[17] = t7, $[18] = t8, $[19] = t9, $[20] = t10) : t10 = $[20];
  let t11;
  $[21] !== t10 || $[22] !== t6 ? (t11 = (0, import_jsx_runtime.jsxs)(TabList, { space: 1, flex: 1, children: [
    t6,
    t10
  ...
  let t16;
  $[30] !== props.onClose || $[31] !== t12 || $[32] !== t15 ? (t16 = (0, import_jsx_runtime.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime.jsx)(Button2, { "aria-label": t12, icon: CloseIcon, mode: "bleed", onClick: t13, tooltipProps: t15 }) }), $[30] = props.onClose, $[31] = t12, $[32] = t15, $[33] = t16) : t16 = $[33];
  let t17;
  $[34] !== t11 || $[35] !== t16 ? (t17 = (0, import_jsx_runtime.jsxs)(Flex, { align: "center", padding: 3, gap: 2, children: [
    t11,
    t16
  ] }), $[34] = t11, $[35] = t16, $[36] = t17) : t17 = $[36];
  const t18 = paneRouterTab !== "history";
  let t19;
  $[37] !== paneRouterTab || $[38] !== ((_b = (_a = source.beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents) ? (t19 = ((_d = (_c = source.beta) == null ? void 0 : _c.eventsAPI) == null ? void 0 : _d.documents) ? (0, import_jsx_runtime.jsx)(EventsSelector, { showList: paneRouterTab === "history" }) : (0, import_jsx_runtime.jsx)(HistorySelector, { showList: paneRouterTab === "history" }), $[37] = paneRouterTab, $[38] = (_f = (_e = source.beta) == null ? void 0 : _e.eventsAPI) == null ? void 0 : _f.documents, $[39] = t19) : t19 = $[39];
  let t20;
  $[40] !== t18 || $[41] !== t19 ? (t20 = (0, import_jsx_runtime.jsx)(TabPanel, { "aria-labelledby": "history-tab", height: "fill", hidden: t18, id: "history-panel", children: t19 }), $[40] = t18, $[41] = t19, $[42] = t20) : t20 = $[42];
  const t21 = paneRouterTab !== "review";
  let t22;
  $[43] !== paneRouterTab || $[44] !== ((_h = (_g = source.beta) == null ? void 0 : _g.eventsAPI) == null ? void 0 : _h.documents) ? (t22 = ((_j = (_i = source.beta) == null ? void 0 : _i.eventsAPI) == null ? void 0 : _j.documents) ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: paneRouterTab === "review" ? (0, import_jsx_runtime.jsx)(EventsInspector, { showChanges: paneRouterTab === "review" }) : null }) : (0, import_jsx_runtime.jsx)(ChangesInspector, { showChanges: paneRouterTab === "review" }), $[43] = paneRouterTab, $[44] = (_l = (_k = source.beta) == null ? void 0 : _k.eventsAPI) == null ? void 0 : _l.documents, $[45] = t22) : t22 = $[45];
  let t23;
  $[46] !== t21 || $[47] !== t22 ? (t23 = (0, import_jsx_runtime.jsx)(TabPanel, { "aria-labelledby": "review-tab", hidden: t21, id: "review-panel", height: "fill", children: t22 }), $[46] = t21, $[47] = t22, $[48] = t23) : t23 = $[48];
  let t24;
  return $[49] !== t17 || $[50] !== t2 || $[51] !== t20 || $[52] !== t23 ? (t24 = (0, import_jsx_runtime.jsxs)(FadeInFlex, { direction: "column", padding: 0, height: "fill", "data-ready": t2, children: [
    t17,
    t20,
    t23
...
function ValidationCard(props) {
  ...
  const handleOpen = t0, [errorInfo, setErrorInfo] = (0, import_react.useState)(null), Icon = MARKER_ICON[marker.level];
  let t1;
  ...
  let t2;
  $[5] !== Icon || $[6] !== errorInfo || $[7] !== handleOpen || $[8] !== marker.level || $[9] !== marker.message || $[10] !== marker.path || $[11] !== schemaType || $[12] !== value ? (t2 = !errorInfo && (0, import_jsx_runtime.jsx)(Card, { __unstable_focusRing: true, as: "button", onClick: handleOpen, padding: 3, radius: 2, tone: MARKER_TONE[marker.level], children: (0, import_jsx_runtime.jsxs)(Flex, { align: "flex-start", gap: 3, children: [
    (0, import_jsx_runtime.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Icon, {}) }) }),
  ...
  let t3;
  return $[14] !== t1 || $[15] !== t2 ? (t3 = (0, import_jsx_runtime.jsxs)(ErrorBoundary, { onCatch: setErrorInfo, children: [
    t1,
    t2
...
function useMenuItem(props) {
  ...
  } = useValidationStatus(documentId, documentType, selectedReleaseId), validation = (0, import_react.useMemo)(() => validationMarkers.map((item) => ({
    level: item.level,
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react.lazy)(() => import("./index3-5JAY7RB4.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-GCZPTS7G.js.map
