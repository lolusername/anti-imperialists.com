...
{:else if node.style === 'h3'}
  <h3 class="text-2xl font-bold text-white">{children}</h3>
{:else if node.style === 'h4'}
  <h4 class="text-xl font-bold text-white">{children}</h4>
{:else if node.style === 'blockquote'}
  <blockquote class="border-l-4 border-[#2E8B57] pl-4 text-white">{children}</blockquote>
{:else if node.listItem === 'bullet'}
